...
* **Programmable transforms** - [Lua][docs.transforms.lua], [Javascript (coming soon)][urls.pr_721], and [WASM (coming soon)][urls.issue_1802] make Vector fully programmable.
...
* **Config unit tests** - [Develop Vector config files like code][docs.guides.unit-testing]. Avoid the frustrating and repetitive development style required by other tools.
