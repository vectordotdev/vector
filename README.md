...
[docs.archives]: https://vector.dev/docs/docs/setup/installation/manual/from-archives
[docs.concepts]: https://vector.dev/docs/docs/about/concepts
[docs.configuration]: https://vector.dev/docs/docs/setup/configuration
[docs.containers]: https://vector.dev/docs/docs/setup/installation/containers
[docs.correctness]: https://vector.dev/docs/docs/about/correctness
[docs.data-model#log]: https://vector.dev/docs/docs/about/data-model#log
[docs.data-model#metric]: https://vector.dev/docs/docs/about/data-model#metric
[docs.data-model.log]: https://vector.dev/docs/docs/about/data-model/log
[docs.data-model.metric]: https://vector.dev/docs/docs/about/data-model/metric
[docs.data_model]: https://vector.dev/docs/docs/about/data-model
[docs.deployment]: https://vector.dev/docs/docs/setup/deployment
[docs.from-archives]: https://vector.dev/docs/docs/setup/installation/manual/from-archives
[docs.from-source]: https://vector.dev/docs/docs/setup/installation/manual/from-source
[docs.guarantees]: https://vector.dev/docs/docs/about/guarantees
[docs.guides]: https://vector.dev/docs/docs/guides
...
[docs.operating_systems]: https://vector.dev/docs/docs/setup/installation/operating-systems
[docs.package_managers]: https://vector.dev/docs/docs/setup/installation/package-managers
[docs.performance]: https://vector.dev/docs/docs/about/performance
[docs.process-management#reloading]: https://vector.dev/docs/docs/administration/process-management#reloading
[docs.process-management]: https://vector.dev/docs/docs/administration/process-management
...
[docs.roles]: https://vector.dev/docs/docs/setup/deployment/roles
[docs.sinks.aws_cloudwatch_logs]: https://vector.dev/docs/docs/components/sinks/aws_cloudwatch_logs
[docs.sinks.aws_cloudwatch_metrics]: https://vector.dev/docs/docs/components/sinks/aws_cloudwatch_metrics
[docs.sinks.aws_kinesis_streams]: https://vector.dev/docs/docs/components/sinks/aws_kinesis_streams
[docs.sinks.aws_s3]: https://vector.dev/docs/docs/components/sinks/aws_s3
[docs.sinks.blackhole]: https://vector.dev/docs/docs/components/sinks/blackhole
[docs.sinks.clickhouse]: https://vector.dev/docs/docs/components/sinks/clickhouse
[docs.sinks.console]: https://vector.dev/docs/docs/components/sinks/console
[docs.sinks.datadog_metrics]: https://vector.dev/docs/docs/components/sinks/datadog_metrics
[docs.sinks.elasticsearch]: https://vector.dev/docs/docs/components/sinks/elasticsearch
[docs.sinks.file]: https://vector.dev/docs/docs/components/sinks/file
[docs.sinks.http]: https://vector.dev/docs/docs/components/sinks/http
[docs.sinks.kafka]: https://vector.dev/docs/docs/components/sinks/kafka
[docs.sinks.prometheus]: https://vector.dev/docs/docs/components/sinks/prometheus
[docs.sinks.splunk_hec]: https://vector.dev/docs/docs/components/sinks/splunk_hec
[docs.sinks.statsd]: https://vector.dev/docs/docs/components/sinks/statsd
[docs.sinks.tcp]: https://vector.dev/docs/docs/components/sinks/tcp
[docs.sinks.vector]: https://vector.dev/docs/docs/components/sinks/vector
...
[docs.sources.file]: https://vector.dev/docs/docs/components/sources/file
[docs.sources.journald]: https://vector.dev/docs/docs/components/sources/journald
[docs.sources.kafka]: https://vector.dev/docs/docs/components/sources/kafka
[docs.sources.statsd]: https://vector.dev/docs/docs/components/sources/statsd
[docs.sources.stdin]: https://vector.dev/docs/docs/components/sources/stdin
[docs.sources.syslog]: https://vector.dev/docs/docs/components/sources/syslog
[docs.sources.tcp]: https://vector.dev/docs/docs/components/sources/tcp
[docs.sources.udp]: https://vector.dev/docs/docs/components/sources/udp
[docs.sources.vector]: https://vector.dev/docs/docs/components/sources/vector
[docs.sources]: https://vector.dev/docs/docs/components/sources
[docs.topologies]: https://vector.dev/docs/docs/setup/deployment/topologies
[docs.transforms.add_fields]: https://vector.dev/docs/docs/components/transforms/add_fields
[docs.transforms.add_tags]: https://vector.dev/docs/docs/components/transforms/add_tags
[docs.transforms.coercer]: https://vector.dev/docs/docs/components/transforms/coercer
[docs.transforms.field_filter]: https://vector.dev/docs/docs/components/transforms/field_filter
[docs.transforms.grok_parser]: https://vector.dev/docs/docs/components/transforms/grok_parser
[docs.transforms.json_parser]: https://vector.dev/docs/docs/components/transforms/json_parser
[docs.transforms.log_to_metric]: https://vector.dev/docs/docs/components/transforms/log_to_metric
[docs.transforms.lua]: https://vector.dev/docs/docs/components/transforms/lua
[docs.transforms.regex_parser]: https://vector.dev/docs/docs/components/transforms/regex_parser
[docs.transforms.remove_fields]: https://vector.dev/docs/docs/components/transforms/remove_fields
[docs.transforms.remove_tags]: https://vector.dev/docs/docs/components/transforms/remove_tags
[docs.transforms.sampler]: https://vector.dev/docs/docs/components/transforms/sampler
[docs.transforms.split]: https://vector.dev/docs/docs/components/transforms/split
[docs.transforms.tokenizer]: https://vector.dev/docs/docs/components/transforms/tokenizer
[docs.transforms]: https://vector.dev/docs/docs/components/transforms
[docs.updating]: https://vector.dev/docs/docs/administration/updating
[docs.use_cases]: https://vector.dev/docs/docs/use_cases
[docs.validating]: https://vector.dev/docs/docs/administration/validating
