...
/// Canonical Datadog metric unit for a metric variant (from https://docs.datadoghq.com/metrics/units/).
pub const DOCS_META_UNIT: &str = "docs::unit";

/// All valid canonical Datadog metric units
pub const VALID_METRIC_UNITS: &[&str] = &[
    // bytes / bits
    "bit",
    "byte",
    "kibibyte",
