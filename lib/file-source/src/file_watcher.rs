...
impl FileWatcher {
    ...
    pub fn new(
        ...
        let reader = Self::uncompress(rdr, &path);
    ...
    fn uncompress(reader: io::BufReader<File>, path: &PathBuf) -> Box<dyn BufRead> {
        match path.extension().and_then(OsStr::to_str) {
            Some("gzip") | Some("gz") => Box::new(io::BufReader::new(MultiGzDecoder::new(reader))),
