...
struct MapFlatten<'a> {
    values: vrl_structures::Iter<'a, String, Value>,
    inner: Option<Box<MapFlatten<'a>>>,
    parent: Option<String>,
}

impl<'a> MapFlatten<'a> {
    fn new(values: vrl_structures::Iter<'a, String, Value>) -> Self {
        Self {
            values,
            inner: None,
            parent: None,
    ...
    fn new_from_parent(parent: String, values: vrl_structures::Iter<'a, String, Value>) -> Self {
        Self {
            values,
            inner: None,
            parent: Some(parent),
