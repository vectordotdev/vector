...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(4),
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dx, 1),
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_dx, 1), SHIFT(5),
  [19] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dxx, 2),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dxy, 2),
