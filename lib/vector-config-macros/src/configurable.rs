...
fn build_virtual_newtype_schema_fn(virtual_ty: Type) -> proc_macro2::TokenStream {
    quote! {
        fn generate_schema(schema_gen: &mut ::vector_config::schema_gen::SchemaGenerator) -> std::result::Result<::vector_config::schema_gen::SchemaObject, ::vector_config::GenerateError> {
