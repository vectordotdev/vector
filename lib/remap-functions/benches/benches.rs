...
bench_function! {
    assert => remap_functions::Assert;

    literal_comparison {
        args: func_args![condition: expression::Arithmetic::new(
                    Box::new(Expr::from(lit!("foo"))),
                    Box::new(Expr::from(lit!("foo"))),
                    remap::Operator::Equal,
                ), message: "Foo must be foo!"],
        want: Ok(value!(null)),
    }
}
...
bench_function! {
    compact => remap_functions::Compact;
...
bench_function! {
    contains => remap_functions::Contains;
...
bench_function! {
    decode_base64 => remap_functions::DecodeBase64;
...
bench_function! {
    encode_base64 => remap_functions::EncodeBase64;
...
bench_function! {
    encode_json => remap_functions::EncodeJson;
...
bench_function! {
    ends_with => remap_functions::EndsWith;
...
bench_function! {
    flatten => remap_functions::Flatten;
...
bench_function! {
    format_number => remap_functions::FormatNumber;
...
bench_function! {
    format_timestamp => remap_functions::FormatTimestamp;
...
bench_function! {
    includes => remap_functions::Includes;
...
bench_function! {
    ip_cidr_contains => remap_functions::IpCidrContains;
...
bench_function! {
    ip_subnet => remap_functions::IpSubnet;
...
bench_function! {
    ip_to_ipv6 => remap_functions::IpToIpv6;
...
bench_function! {
    ipv6_to_ipv4 => remap_functions::Ipv6ToIpV4;
...
bench_function! {
    is_nullish => remap_functions::IsNullish;
...
bench_function! {
    parse_aws_alb_log => remap_functions::ParseAwsAlbLog;
...
bench_function! {
    parse_aws_cloudwatch_log_subscription_message => remap_functions::ParseAwsCloudWatchLogSubscriptionMessage;
...
bench_function! {
    parse_aws_vpc_flow_log => remap_functions::ParseAwsVpcFlowLog;
...
bench_function! {
    parse_common_log => remap_functions::ParseCommonLog;
...
bench_function! {
    parse_duration => remap_functions::ParseDuration;

    literal {
        args: func_args![value: "1005ms", output: "s"],
        want: Ok(1.005),
    }
}

bench_function! {
    parse_glog  => remap_functions::ParseGlog;
...
bench_function! {
    parse_grok => remap_functions::ParseGrok;
...
bench_function! {
    parse_key_value => remap_functions::ParseKeyValue;
...
bench_function! {
    parse_regex => remap_functions::ParseRegex;
...
bench_function! {
    parse_regex_all => remap_functions::ParseRegexAll;
...
bench_function! {
    parse_syslog => remap_functions::ParseSyslog;
...
bench_function! {
    parse_timestamp => remap_functions::ParseTimestamp;
...
bench_function! {
    parse_tokens => remap_functions::ParseTokens;
...
bench_function! {
    parse_url => remap_functions::ParseUrl;
...
bench_function! {
    replace => remap_functions::Replace;
...
bench_function! {
    starts_with  => remap_functions::StartsWith;
...
bench_function! {
    strip_ansi_escape_codes => remap_functions::StripAnsiEscapeCodes;
...
bench_function! {
    strip_whitespace => remap_functions::StripWhitespace;
...
bench_function! {
    to_bool => remap_functions::ToBool;
...
bench_function! {
    to_float => remap_functions::ToFloat;
...
bench_function! {
    to_string => remap_functions::ToString;
...
bench_function! {
    to_syslog_facility => remap_functions::ToSyslogFacility;
...
bench_function! {
    to_syslog_level => remap_functions::ToSyslogLevel;
...
bench_function! {
    to_syslog_severity => remap_functions::ToSyslogSeverity;
...
bench_function! {
    to_timestamp => remap_functions::ToTimestamp;
...
bench_function! {
    to_unix_timestamp => remap_functions::ToUnixTimestamp;
...
bench_function! {
    truncate => remap_functions::Truncate;
