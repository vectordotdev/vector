...
#[cfg(test)]
mod test {
    use crate::fast_matcher::build_matcher;
    use crate::Filter;
    use crate::Resolver;
    ...
    pub fn get_checks() -> Vec<(&'static str, Event, Event)> {
        vec![
            ...
            (
                "_exists_:@b",
                log_event!["custom" => serde_json::json!({"b": "foo"})],
                log_event!["custom" => serde_json::json!({"a": "foo"})],
            ),
            // Facet exists (negate).
            (
                "NOT _exists_:@b",
            ...
            (
                r#"a:"bla""#,
                log_event!["tags" => vec!["a:bla"]],
                log_event!["custom" => serde_json::json!({"a": "bla"})],
            ),
            ...
            (
                "*b*la*",
                log_event!["custom" => serde_json::json!({"title": "foobla"})],
                log_event![],
            ),
            ...
            (
                "@a:*bla",
                log_event!["custom" => serde_json::json!({"a": "foobla"})],
                log_event!["tags" => vec!["a:foobla"]],
            ),
            ...
            (
                "@b:bla*",
                log_event!["custom" => serde_json::json!({"b": "blabop"})],
                log_event!["tags" => vec!["b:blabop"]],
            ),
            ...
            (
                "@c:*b*la*",
                log_event!["custom" => serde_json::json!({"c": "foobla"})],
                log_event!["tags" => vec!["c:foobla"]],
            ),
            ...
            (
                "@b:[1 TO 10]",
                log_event!["custom" => serde_json::json!({"b": 5})],
                log_event!["custom" => serde_json::json!({"b": 11})],
            ),
            (
                "@b:[1 TO 100]",
                log_event!["custom" => serde_json::json!({"b": "10"})],
                log_event!["custom" => serde_json::json!({"b": "2"})],
            ),
            ...
            (
                "@b:[a TO z]",
                log_event!["custom" => serde_json::json!({"b": "c"})],
                log_event!["custom" => serde_json::json!({"b": 5})],
            ),
            ...
            (
                "@f:{1 TO 100}",
                log_event!["custom" => serde_json::json!({"f": 50})],
                log_event!["custom" => serde_json::json!({"f": 1})],
            ),
            (
                "@f:{1 TO 100}",
                log_event!["custom" => serde_json::json!({"f": 50})],
                log_event!["custom" => serde_json::json!({"f": 100})],
            ),
