...
use crate::internal_events::decoder::{DecoderDeserializeFailed, DecoderFramingFailed};
...
impl Decoder {
    ...
    fn handle_framing_result(
        ...
        let frame = frame.map_err(|error| {
            crate::emit!(DecoderFramingFailed { error: &error });
        ...
        self.deserializer
            ...
            .map_err(|error| {
                crate::emit!(DecoderDeserializeFailed { error: &error });
