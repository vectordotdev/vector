...
use crate::codecs_extra::Transformer;
...
impl EncodingConfig {
    ...
    pub fn build(&self) -> vector_core::Result<Serializer> {
        self.encoding.build()
    }
}
...
impl EncodingConfigWithFraming {
    ...
    pub fn build(&self, sink_type: SinkType) -> vector_core::Result<(Framer, Serializer)> {
