...
fn field_reason() -> Value {
    json!({"description": "The type of the error", "required": true, "enum": {
        "out_of_order": "The event was out of order.",
        "oversized":    "The event was too large."
    }})
}
fn field_error_type() -> Value {
    json!({"description": "The type of the error", "required": true, "enum": {
...
fn field_stage() -> Value {
    json!({"description": "The stage within the component at which the error occurred.", "required": true, "enum": {
...
fn internal_metrics_tags_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| json!({"pid": field_pid(), "host": field_host()}));
    &V
}
...
fn component_tags_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        obj.insert("component_kind".to_owned(), field_component_kind());
        obj.insert("component_id".to_owned(), field_component_id());
        obj.insert("component_type".to_owned(), field_component_type());
        tags
    });
    &V
}
...
fn component_tags_output_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("output".to_owned(), field_output());
        tags
    });
    &V
}
...
fn component_tags_grpc_method_service_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        let mut tags = component_tags_value().clone();
        let obj = tags.as_object_mut().unwrap();
        obj.insert("grpc_method".to_owned(), field_grpc_method());
        obj.insert("grpc_service".to_owned(), field_grpc_service());
        tags
    });
    &V
}
...
fn component_tags_grpc_all_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("grpc_status".to_owned(), field_grpc_status());
        tags
    });
    &V
}
...
fn component_tags_http_method_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("method".to_owned(), field_http_method());
        tags
    });
    &V
}
...
fn component_tags_http_status_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("status".to_owned(), field_http_status());
        tags
    });
    &V
}
...
fn component_tags_http_method_path_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("path".to_owned(), field_http_path());
        tags
    });
    &V
}
...
fn component_tags_error_type_stage_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        let mut tags = component_tags_value().clone();
        let obj = tags.as_object_mut().unwrap();
        obj.insert("error_type".to_owned(), field_error_type());
        obj.insert("stage".to_owned(), field_stage());
        tags
    });
    &V
}
...
fn internal_metrics_tags_file_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("file".to_owned(), field_file());
        tags
    });
    &V
}
...
fn internal_metrics_tags_reason_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        tags.as_object_mut()
            .unwrap()
            .insert("reason".to_owned(), field_reason());
        tags
    });
    &V
}
...
fn component_received_events_total_tags_value() -> &'static Value {
    static V: LazyLock<Value> = LazyLock::new(|| {
        ...
        obj.insert("mode".to_owned(), field_mode_transport());
        tags
    });
    &V
}
