...
pub enum CounterName {
    ...
    #[configurable(tags = metric_tags!(..COMPONENT_RECEIVED_EVENTS_TOTAL_TAGS))]
    ...
    #[configurable(tags = metric_tags!(..COMPONENT_RECEIVED_EVENTS_TAGS))]
    ...
    #[configurable(tags = metric_tags!(..COMPONENT_TAGS_OUTPUT))]
    ...
    #[configurable(tags = metric_tags!(..COMPONENT_TAGS_ERROR_TYPE_STAGE))]
    ComponentErrorsTotal,

    /// The total number of events for which this source responded with a timeout error.
    #[configurable(tags = metric_tags!(..COMPONENT_TAGS))]
    ...
    #[configurable(tags = metric_tags!(..INTERNAL_METRICS_TAGS))]
    ApiStartedTotal,
    ...
    #[configurable(tags = metric_tags!(..INTERNAL_METRICS_TAGS_FILE))]
    ChecksumErrorsTotal,
    ...
    #[configurable(tags = metric_tags!(..INTERNAL_METRICS_TAGS_REASON))]
...
pub enum HistogramName {
    ...
    #[configurable(tags = metric_tags!(..S3_OBJECT_PROCESSING_TAGS))]
...
pub enum GaugeName {
    ...
    #[configurable(
        ...
        tags = metric_tags!(..COMPONENT_TAGS)
    )]
    BufferMaxEventSize,
