...
pub enum GaugeName {
    ...
    UptimeSeconds,
    BuildInfo,
    IggyConsumerLagMessages,
    IggyConsumerPolledOffset,
    IggyConsumerCommittedOffset,
    KafkaQueueMessages,
...
impl GaugeName {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::IggyConsumerLagMessages => "iggy_consumer_lag_messages",
            Self::IggyConsumerPolledOffset => "iggy_consumer_polled_offset",
            Self::IggyConsumerCommittedOffset => "iggy_consumer_committed_offset",
