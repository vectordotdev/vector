...
pub enum CounterName {
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_RECEIVED_EVENTS_TOTAL_TAGS)))]
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_RECEIVED_EVENTS_TAGS)))]
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_OUTPUT)))]
    ...
    #[configurable(metadata(docs::tags = metric_tags! {
        ..COMPONENT_TAGS,
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_ERROR_TYPE_STAGE)))]
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..INTERNAL_METRICS_TAGS)))]
    ApiStartedTotal,
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..INTERNAL_METRICS_TAGS_FILE)))]
    ChecksumErrorsTotal,
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..INTERNAL_METRICS_TAGS_REASON)))]
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_GRPC_METHOD_SERVICE)))]
    GrpcServerMessagesReceivedTotal,

    /// The total number of gRPC messages sent.
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_GRPC_ALL)))]
    GrpcServerMessagesSentTotal,

    /// The total number of HTTP client errors encountered.
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_HTTP_ERROR_KIND)))]
    HttpClientErrorsTotal,

    /// The total number of sent HTTP requests, tagged with the request method.
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_HTTP_METHOD)))]
    HttpClientRequestsSentTotal,

    /// The total number of HTTP requests, tagged with the response code.
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_HTTP_STATUS)))]
    HttpClientResponsesTotal,

    /// The total number of HTTP requests received.
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_HTTP_METHOD_PATH)))]
    HttpServerRequestsReceivedTotal,

    /// The total number of HTTP responses sent.
    #[configurable(metadata(docs::tags = metric_tags!(..COMPONENT_TAGS_HTTP_ALL)))]
...
pub enum HistogramName {
    ...
    #[configurable(metadata(docs::tags = metric_tags!(..S3_OBJECT_PROCESSING_TAGS)))]
...
pub enum GaugeName {
    ...
    #[configurable(
        ...
        metadata(docs::tags = metric_tags!(..COMPONENT_TAGS))
    )]
    BufferMaxEventSize,
