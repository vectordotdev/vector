...
fn main() {
    ...
    let pkg_name = tracker
        ...
        .expect("Cargo-provided environment variables should always exist! - CARGO_PKG_NAME");
    ...
    let target_arch = tracker
        ...
        .expect("Cargo-provided environment variables should always exist! - CARGO_CFG_TARGET_ARCH");
    let target_os = tracker
        .get_env_var("CARGO_CFG_TARGET_OS")
        .expect("Cargo-provided environment variables should always exist! - CARGO_CFG_TARGET_OS");
    let target_vendor = tracker
        .get_env_var("CARGO_CFG_TARGET_VENDOR")
        .expect("Cargo-provided environment variables should always exist! - CARGO_CFG_TARGET_VENDOR");
    let debug = tracker
        .get_env_var("DEBUG")
