...
check-all: check-fmt check-clippy check-style check-markdown check-meta check-blog check-version check-examples check-component-features check-scripts ## Check everything
