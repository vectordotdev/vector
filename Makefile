...
package-x86_64-musl-all: package-archive-x86_64-unknown-linux-musl package-deb-x86_64 package-rpm-x86_64 # Build all x86_64 MUSL packages

package-armv7-musl-all: package-archive-armv7-unknown-linux-musl package-deb-armv7 package-rpm-armv7  # Build all armv7 MUSL packages

package-aarch64-musl-all: package-archive-aarch64-unknown-linux-musl package-deb-aarch64 package-rpm-aarch64  # Build all aarch64 MUSL packages
