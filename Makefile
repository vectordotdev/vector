...
.PHONY: package-all
package-all: package-x86_64-unknown-linux-musl package-x86_64-unknown-linux-gnu-all
package-all: package-aarch64-unknown-linux-musl-all ## Build all packages
...
package-deb-all: package-deb-x86_64 package-deb-aarch64 ## Build all deb packages
