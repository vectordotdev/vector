The Vector observability API has been migrated from GraphQL to gRPC for improved performance, efficiency and maintainability.
...
* Remove the `api.graphql` and `api.playground` fields from your config. Vector will now reject configs that contain them.
