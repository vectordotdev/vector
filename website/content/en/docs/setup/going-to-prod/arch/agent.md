...
- Enable [end-to-end acknowledgements](/docs/introduction/introduction/architecture/end-to-end-acknowledgements/) to mitigate [data receive failures](/docs/setup/going-to-prod/high-availability/#data-receive-failure).
