...
{{< info >}}
The value is derived from the [`timestamp` field](/docs/introduction/introduction/architecture/data-model/log/#timestamps)
...
[log]: /docs/introduction/introduction/architecture/data-model/log
