...
7. [AWS SDK Migration](#aws-sdk-migration)
...
been migrated. It is still possible to use a credentials file, but it must be stored in the default location (`~/.aws/credentials`)
