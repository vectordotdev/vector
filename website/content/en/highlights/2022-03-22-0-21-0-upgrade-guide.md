...
A new `_unmatched` route has now been introduced and the events are no longer discarded, making the `RouteEventDiscarded`
event and the `event_discarded_total` metric irrelevant. They are now being dropped.
