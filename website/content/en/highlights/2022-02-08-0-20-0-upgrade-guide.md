...
- `processing_errors_total` metric removed, as it duplicated the existing
...
- Associated log now emitted at DEBUG, rather than WARN
- `processing_errors_total` metric replaced with `rewritten_timestamp_events_total`
