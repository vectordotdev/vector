...
through unchanged. If your config uses those forms, use a preprocessor that implements Vector's interpolation
grammar instead. See the [environment variables reference](/docs/reference/environment_variables/#security-restrictions)
for more details.
