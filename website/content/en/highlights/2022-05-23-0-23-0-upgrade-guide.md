...
The "ndjson" encoding value will be phased out since the "newline-delimited" behavior can now be set
in a dedicated "framing" field.

Sinks that previously used
...
if the sinks supports framing or as
