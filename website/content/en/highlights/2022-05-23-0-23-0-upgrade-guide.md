...
If you are using the VRL merge operator (`|`) on objects that share keys with different types, the type definition
was calculated incorrectly. This is now fixed. In some rare cases this can cause compilation errors when upgrading
