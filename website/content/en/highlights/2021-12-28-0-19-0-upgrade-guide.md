...
3. [Removal of deprecated configuration fields for the Elasticsearch sink](#elasticsearch-sink-deprecated-fields)
4. [Removal of default for `version` field for Vector source and sink](#vector-version)
