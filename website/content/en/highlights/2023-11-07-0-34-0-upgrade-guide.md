...
1. [Removal of Deprecated `component_name` Metric Tag](#deprecated-comoponent-name)
...
#### Removal of Deprecated `component_name` Metric Tag {#deprecated-comoponent-name}
