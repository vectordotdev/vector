...
adapted to send them to any other [destination of your
choice](https://vector.dev/docs/reference/sinks/).
...
<IMG src="/img/aws-kinesis-firehose-to-vector.png" />
...
<!--
    ...
    guides/advanced/cloudwatch-logs-firehose.md.erb
-->
