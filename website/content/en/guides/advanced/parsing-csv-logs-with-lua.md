...
This guide walks through reading CSV logs using [`file`][docs.sources.file] source and parsing them using
[`lua`][docs.transforms.lua] transform with a loadable Lua module.
