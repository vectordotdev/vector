...
First, let's talk a bit about what Vector plugins are! Just want to dig in? [**Fastpath to Hacking!**][#Understanding-the-Current-Limitations]
...
<!--
    ...
    guides/advanced/wasm-hello.md.erb
-->
