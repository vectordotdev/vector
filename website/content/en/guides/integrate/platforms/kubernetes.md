...
description: "A simple guide to send logs from Kubernetes to anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Integration"
tags: ["type: tutorial","domain: platforms","platform: kubernetes","source: kubernetes_logs"]
...
send logs from Kubernetes to anywhere.
...
<!--
    ...
    guides/integrate/platforms/kubernetes.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"console","inputs":["my-source-or-transform-id","prefix-*"],"encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
