...
description: "A simple guide to send logs from Docker to File in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to File Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: file"]
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.file_interface"
