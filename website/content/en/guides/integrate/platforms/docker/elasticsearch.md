...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: elasticsearch"]
...
send logs from Docker to Elasticsearch.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Elasticsearch](https://www.elastic.co/products/elasticsearch).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.elasticsearch_interface"
