...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: influxdb_logs"]
...
send logs from Docker to InfluxDB.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [InfluxDB](https://www.influxdata.com/products/influxdb-overview/).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.influxdb_logs_interface"
