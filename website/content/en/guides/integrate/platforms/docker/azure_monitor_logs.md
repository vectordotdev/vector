---
$schema: "../../../.schema.json"
title: "Send logs from Docker to Azure Monitor logs"
description: "A simple guide to send logs from Docker to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: azure_monitor_logs"]
...
send logs from Docker to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/platforms/docker/azure_monitor_logs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Azure Monitor logs](https://azure.microsoft.com/en-us/services/monitor/).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.azure_monitor_logs_interface"
