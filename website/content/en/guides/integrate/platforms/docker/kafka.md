...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: kafka"]
...
send logs from Docker to Kafka.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.kafka_interface"
