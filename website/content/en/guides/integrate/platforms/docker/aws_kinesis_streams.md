...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: aws_kinesis_streams"]
...
send logs from Docker to AWS Kinesis Data Streams.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.aws_kinesis_streams_interface"
