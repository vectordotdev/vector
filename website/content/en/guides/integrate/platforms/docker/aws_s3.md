...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: aws_s3"]
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [AWS S3](https://aws.amazon.com/s3/).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.aws_s3_interface"
