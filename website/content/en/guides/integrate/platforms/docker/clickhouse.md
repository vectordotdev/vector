...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: clickhouse"]
...
send logs from Docker to Clickhouse.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.clickhouse_interface"
