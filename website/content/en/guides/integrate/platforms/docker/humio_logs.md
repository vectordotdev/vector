...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: humio_logs"]
...
send logs from Docker to Humio.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.humio_logs_interface"
