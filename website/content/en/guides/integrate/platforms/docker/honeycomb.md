...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: honeycomb"]
...
send logs from Docker to Honeycomb.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.honeycomb_interface"
