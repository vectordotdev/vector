...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: loki"]
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Loki](https://grafana.com/oss/loki/).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.loki_interface"
