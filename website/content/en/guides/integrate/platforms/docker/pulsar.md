...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: pulsar"]
...
send logs from Docker to Apache Pulsar.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.pulsar_interface"
