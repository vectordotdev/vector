...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: papertrail"]
...
send logs from Docker to Papertrail.
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.papertrail_interface"
