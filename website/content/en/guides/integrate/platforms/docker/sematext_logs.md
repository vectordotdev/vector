...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: sematext_logs"]
...
send logs from Docker to Sematext.
...
[Sematext](https://sematext.com) is a hosted monitoring platform based on Elasticsearch. Providing powerful monitoring and management solutions to monitor and observe your apps in real-time.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Sematext](https://sematext.com).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.sematext_logs_interface"
