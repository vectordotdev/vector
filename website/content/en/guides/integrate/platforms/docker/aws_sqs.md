---
$schema: "../../../.schema.json"
title: "Send logs from Docker to AWS Simple Queue Service"
description: "A simple guide to send logs from Docker to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: aws_sqs"]
...
send logs from Docker to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/platforms/docker/aws_sqs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [AWS Simple Queue Service](https://aws.amazon.com/sqs/).
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.aws_sqs_interface"
