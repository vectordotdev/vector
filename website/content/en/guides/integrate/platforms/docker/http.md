...
description: "A simple guide to send logs from Docker to HTTP in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to HTTP Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker_logs","sink: http"]
...
<Tabs
  ...
  groupId="integration-guide-docker.docker_logs.http_interface"
