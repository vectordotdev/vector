...
description: "A simple guide to send logs from Kubernetes to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Papertrail Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: papertrail"]
...
send logs from Kubernetes to Papertrail.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/papertrail.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.papertrail_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"papertrail","inputs":["my-source-or-transform-id","prefix-*"],"endpoint":"logs.papertrailapp.com:12345","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
