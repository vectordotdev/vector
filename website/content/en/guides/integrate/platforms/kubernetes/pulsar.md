...
description: "A simple guide to send logs from Kubernetes to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Apache Pulsar Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: pulsar"]
...
send logs from Kubernetes to Apache Pulsar.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/pulsar.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.pulsar_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"pulsar","inputs":["my-source-or-transform-id","prefix-*"],"endpoint":"pulsar://127.0.0.1:6650","topic":"topic-1234","encoding":{"codec":"text"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
