...
description: "A simple guide to send logs from Kubernetes to AWS S3 in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to AWS S3 Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: aws_s3"]
...
send logs from Kubernetes to AWS S3.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/aws_s3.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.aws_s3_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"aws_s3","inputs":["my-source-or-transform-id","prefix-*"],"bucket":"my-bucket","region":"us-east-1","encoding":{"codec":"ndjson"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
