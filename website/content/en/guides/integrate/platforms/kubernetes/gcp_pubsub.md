...
description: "A simple guide to send logs from Kubernetes to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to GCP PubSub Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: gcp_pubsub"]
...
send logs from Kubernetes to GCP PubSub.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/gcp_pubsub.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.gcp_pubsub_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"gcp_pubsub","inputs":["my-source-or-transform-id","prefix-*"],"project":"vector-123456","topic":"this-is-a-topic","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
