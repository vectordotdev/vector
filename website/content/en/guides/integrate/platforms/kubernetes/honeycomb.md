...
description: "A simple guide to send logs from Kubernetes to Honeycomb in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Honeycomb Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: honeycomb"]
...
send logs from Kubernetes to Honeycomb.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/honeycomb.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.honeycomb_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"honeycomb","inputs":["my-source-or-transform-id","prefix-*"],"api_key":"${HONEYCOMB_API_KEY}","dataset":"my-honeycomb-dataset","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
