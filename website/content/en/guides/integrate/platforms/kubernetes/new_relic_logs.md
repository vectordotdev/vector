---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to New Relic logs"
description: "A simple guide to send logs from Kubernetes to New Relic logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to New Relic Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: new_relic_logs"]
...
send logs from Kubernetes to New Relic logs.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/new_relic_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.new_relic_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"new_relic_logs","inputs":["my-source-or-transform-id","prefix-*"],"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
