---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to GCP Cloud Storage"
description: "A simple guide to send logs from Kubernetes to GCP Cloud Storage in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: gcp_cloud_storage"]
...
send logs from Kubernetes to GCP Cloud Storage.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/gcp_cloud_storage.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.gcp_cloud_storage_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"gcp_cloud_storage","inputs":["my-source-or-transform-id","prefix-*"],"bucket":"my-bucket","encoding":{"codec":"ndjson"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
