...
description: "A simple guide to send logs from Kubernetes to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Elasticsearch Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: elasticsearch"]
...
send logs from Kubernetes to Elasticsearch.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/elasticsearch.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.elasticsearch_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"elasticsearch","inputs":["my-source-or-transform-id","prefix-*"],"endpoint":"http://10.24.32.122:9000","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
