---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to Splunk"
description: "A simple guide to send logs from Kubernetes to Splunk in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Splunk HEC Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: splunk_hec"]
...
send logs from Kubernetes to Splunk.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/splunk_hec.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.splunk_hec_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"splunk_hec","inputs":["my-source-or-transform-id","prefix-*"],"endpoint":"https://http-inputs-hec.splunkcloud.com","token":"${SPLUNK_HEC_TOKEN}","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
