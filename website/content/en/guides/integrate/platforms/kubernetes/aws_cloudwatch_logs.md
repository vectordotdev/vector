---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to AWS Cloudwatch logs"
description: "A simple guide to send logs from Kubernetes to AWS Cloudwatch logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: aws_cloudwatch_logs"]
...
send logs from Kubernetes to AWS Cloudwatch logs.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/aws_cloudwatch_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.aws_cloudwatch_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"aws_cloudwatch_logs","inputs":["my-source-or-transform-id","prefix-*"],"group_name":"group-name","region":"us-east-1","stream_name":"{{ host }}","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
