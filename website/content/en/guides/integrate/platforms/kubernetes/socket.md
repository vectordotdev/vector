---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to socket receiver"
description: "A simple guide to send logs from Kubernetes to socket receiver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Socket Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: socket"]
...
<!--
    ...
    guides/integrate/platforms/kubernetes/socket.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.socket_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"socket","inputs":["my-source-or-transform-id","prefix-*"],"address":"92.12.333.224:5000","mode":"tcp","path":"/path/to/socket","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
