...
description: "A simple guide to send logs from Kubernetes to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Humio Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: humio_logs"]
...
send logs from Kubernetes to Humio.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/humio_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.humio_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"humio_logs","inputs":["my-source-or-transform-id","prefix-*"],"token":"${HUMIO_TOKEN}","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
