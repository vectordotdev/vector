...
description: "A simple guide to send logs from Kubernetes to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Sematext Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: sematext_logs"]
...
send logs from Kubernetes to Sematext.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/sematext_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.sematext_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"sematext_logs","inputs":["my-source-or-transform-id","prefix-*"],"region":"us","token":"${SEMATEXT_TOKEN}","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
