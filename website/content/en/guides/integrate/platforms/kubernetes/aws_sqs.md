---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to AWS Simple Queue Service"
description: "A simple guide to send logs from Kubernetes to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: aws_sqs"]
...
send logs from Kubernetes to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/aws_sqs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.aws_sqs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"aws_sqs","inputs":["my-source-or-transform-id","prefix-*"],"queue_url":"https://sqs.us-east-2.amazonaws.com/123456789012/MyQueue","region":"us-east-1","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
