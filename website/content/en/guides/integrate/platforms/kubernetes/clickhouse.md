...
description: "A simple guide to send logs from Kubernetes to Clickhouse in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Clickhouse Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: clickhouse"]
...
send logs from Kubernetes to Clickhouse.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/clickhouse.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.clickhouse_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"clickhouse","inputs":["my-source-or-transform-id","prefix-*"],"endpoint":"http://localhost:8123","table":"mytable","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
