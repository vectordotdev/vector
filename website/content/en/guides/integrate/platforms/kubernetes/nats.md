---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to NATS"
description: "A simple guide to send logs from Kubernetes to NATS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to NATS Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: nats"]
...
send logs from Kubernetes to NATS.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/nats.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.nats_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"nats","inputs":["my-source-or-transform-id","prefix-*"],"subject":"{{ host }}","url":"nats://demo.nats.io","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
