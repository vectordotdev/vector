...
cover_label: "Kubernetes to Loki Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: loki"]
...
<!--
    ...
    guides/integrate/platforms/kubernetes/loki.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.loki_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"loki","inputs":["my-source-or-transform-id","prefix-*"],"endpoint":"http://localhost:3100","encoding":{"codec":"json"},"labels":{"forwarder":"vector","event":"{{ event_field }}","key":"value"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
