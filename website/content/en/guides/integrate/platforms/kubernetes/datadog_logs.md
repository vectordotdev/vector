---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to Datadog logs"
description: "A simple guide to send logs from Kubernetes to Datadog logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Datadog Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: datadog_logs"]
...
send logs from Kubernetes to Datadog logs.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/datadog_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.datadog_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"datadog_logs","inputs":["my-source-or-transform-id","prefix-*"],"api_key":"${DATADOG_API_KEY_ENV_VAR}","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
