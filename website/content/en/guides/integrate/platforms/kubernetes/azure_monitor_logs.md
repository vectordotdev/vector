---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to Azure Monitor logs"
description: "A simple guide to send logs from Kubernetes to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: azure_monitor_logs"]
...
send logs from Kubernetes to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.azure_monitor_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"azure_monitor_logs","inputs":["my-source-or-transform-id","prefix-*"],"customer_id":"5ce893d9-2c32-4b6c-91a9-b0887c2de2d6","log_type":"MyTableName","shared_key":"${AZURE_MONITOR_SHARED_KEY_ENV_VAR}","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
