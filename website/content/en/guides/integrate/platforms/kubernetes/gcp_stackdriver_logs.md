---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from Kubernetes to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to GCP Operations (formerly Stackdrive) Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: gcp_stackdriver_logs"]
...
send logs from Kubernetes to GCP Operations (formerly Stackdriver) logs.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/gcp_stackdriver_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.gcp_stackdriver_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"gcp_stackdriver_logs","inputs":["my-source-or-transform-id","prefix-*"],"log_id":"vector-logs","project_id":"vector-123456","resource":{"type":"global","projectId":"vector-123456","instanceId":"Twilight","zone":"us-central1-a"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
