---
$schema: "../../../.schema.json"
title: "Send logs from Kubernetes to HTTP"
description: "A simple guide to send logs from Kubernetes to HTTP in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to HTTP Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: http"]
...
send logs from Kubernetes to HTTP.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/http.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.http_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"http","inputs":["my-source-or-transform-id","prefix-*"],"uri":"https://10.22.212.22:9000/endpoint","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
