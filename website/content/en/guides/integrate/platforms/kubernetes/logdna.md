...
description: "A simple guide to send logs from Kubernetes to LogDNA in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to LogDNA Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: logdna"]
...
send logs from Kubernetes to LogDNA.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/logdna.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.logdna_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"logdna","inputs":["my-source-or-transform-id","prefix-*"],"api_key":"${LOGDNA_API_KEY}","hostname":"${HOSTNAME}","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
