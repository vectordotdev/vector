...
description: "A simple guide to send logs from Kubernetes to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: aws_kinesis_streams"]
...
send logs from Kubernetes to AWS Kinesis Data Streams.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/aws_kinesis_streams.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.aws_kinesis_streams_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"aws_kinesis_streams","inputs":["my-source-or-transform-id","prefix-*"],"region":"us-east-1","stream_name":"my-stream","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
