...
description: "A simple guide to send logs from Kubernetes to AWS Kinesis Firehose in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes to AWS Kinesis Firehose Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: aws_kinesis_firehose"]
...
send logs from Kubernetes to AWS Kinesis Firehose.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/aws_kinesis_firehose.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.aws_kinesis_firehose_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"aws_kinesis_firehose","inputs":["my-source-or-transform-id","prefix-*"],"region":"us-east-1","stream_name":"my-stream","encoding":{"codec":"json"},"inputs":["kubernetes_logs"]}}}}
      format={"toml"}
