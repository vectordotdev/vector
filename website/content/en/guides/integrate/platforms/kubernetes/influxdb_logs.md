...
cover_label: "Kubernetes to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: kubernetes","source: kubernetes_logs","sink: influxdb_logs"]
...
send logs from Kubernetes to InfluxDB.
...
<!--
    ...
    guides/integrate/platforms/kubernetes/influxdb_logs.md.erb
-->
...
<Tabs
  ...
  className={null}
  defaultValue={"helm3"}
  groupId="integration-guide-kubernetes.kubernetes_logs.influxdb_logs_interface"
...
1.  ### Configure Vector
    ...
    <ConfigExample
      config={{"sources":{"kubernetes_logs":{"type":"kubernetes_logs"}},"sinks":{"out":{"type":"influxdb_logs","inputs":["my-source-or-transform-id","prefix-*"],"bucket":"vector-bucket","database":"vector-database","endpoint":"http://localhost:8086/","namespace":"service","org":"my-org","token":"${INFLUXDB_TOKEN}","inputs":["kubernetes_logs"]}}}}
      format={"toml"}
