...
cover_label: "Prometheus Exporter Integration"
tags: ["type: tutorial","domain: sinks","sink: prometheus_exporter"]
...
<!--
    ...
    guides/integrate/sinks/prometheus_exporter.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-prometheus_exporter_interface"
