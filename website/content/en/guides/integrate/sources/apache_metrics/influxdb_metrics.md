---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to InfluxDB"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to InfluxDB Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: influxdb_metrics"]
...
send metrics from Apache HTTP server (HTTPD) to InfluxDB.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/influxdb_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.influxdb_metrics_interface"
