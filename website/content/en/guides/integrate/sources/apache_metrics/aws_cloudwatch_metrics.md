---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to AWS Cloudwatch metrics"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to AWS Cloudwatch metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: aws_cloudwatch_metrics"]
...
send metrics from Apache HTTP server (HTTPD) to AWS Cloudwatch metrics.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/aws_cloudwatch_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.aws_cloudwatch_metrics_interface"
