---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to Datadog metrics"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to Datadog metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to Datadog Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: datadog_metrics"]
...
send metrics from Apache HTTP server (HTTPD) to Datadog metrics.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/datadog_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.datadog_metrics_interface"
