---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to Humio"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to Humio Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: humio_metrics"]
...
send metrics from Apache HTTP server (HTTPD) to Humio.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/humio_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.humio_metrics_interface"
