---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to Sematext"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to Sematext Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: sematext_metrics"]
...
send metrics from Apache HTTP server (HTTPD) to Sematext.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/sematext_metrics.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends metrics to [Sematext](https://sematext.com).
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.sematext_metrics_interface"
