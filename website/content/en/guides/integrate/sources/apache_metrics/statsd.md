---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to Statsd receiver"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to Statsd receiver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to Statsd Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: statsd"]
...
send metrics from Apache HTTP server (HTTPD) to Statsd receiver.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/statsd.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.statsd_interface"
