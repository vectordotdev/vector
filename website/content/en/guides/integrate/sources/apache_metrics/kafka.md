---
$schema: "../../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to Kafka"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: apache_metrics","sink: kafka"]
...
send metrics from Apache HTTP server (HTTPD) to Kafka.
...
<!--
    ...
    guides/integrate/sources/apache_metrics/kafka.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics.kafka_interface"
