---
$schema: "../../.schema.json"
title: "Send metrics from a Host (Node) to anywhere"
description: "A simple guide to send metrics from a Host (Node) to anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics Integration"
tags: ["type: tutorial","domain: sources","source: host_metrics"]
...
send metrics from a Host (Node) to anywhere.
...
<!--
    ...
    guides/integrate/sources/host_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics_interface"
