---
$schema: "../../../.schema.json"
title: "Send logs from HTTP to Azure Monitor logs"
description: "A simple guide to send logs from HTTP to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: azure_monitor_logs"]
...
send logs from HTTP to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/http/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-http.azure_monitor_logs_interface"
