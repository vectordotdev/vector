---
$schema: "../../../.schema.json"
title: "Send logs from HTTP to Splunk"
description: "A simple guide to send logs from HTTP to Splunk in just a few minutes."
...
<Tabs
  ...
  groupId="integration-guide-http.splunk_hec_interface"
