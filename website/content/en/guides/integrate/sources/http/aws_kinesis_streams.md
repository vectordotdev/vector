...
send logs from HTTP to AWS Kinesis Data Streams.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives logs from [HTTP](https://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol#Client_request).
    * Enriches data with useful HTTP context.
...
<Tabs
  ...
  groupId="integration-guide-http.aws_kinesis_streams_interface"
