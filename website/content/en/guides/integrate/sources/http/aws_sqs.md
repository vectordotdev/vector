---
$schema: "../../../.schema.json"
title: "Send logs from HTTP to AWS Simple Queue Service"
description: "A simple guide to send logs from HTTP to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: aws_sqs"]
...
send logs from HTTP to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/http/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-http.aws_sqs_interface"
