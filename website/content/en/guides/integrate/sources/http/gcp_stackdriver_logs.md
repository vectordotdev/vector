---
$schema: "../../../.schema.json"
title: "Send logs from HTTP to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from HTTP to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from HTTP to GCP Operations (formerly Stackdriver) logs.
...
<Tabs
  ...
  groupId="integration-guide-http.gcp_stackdriver_logs_interface"
