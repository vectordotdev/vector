---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus client to Prometheus"
description: "A simple guide to send metrics from Prometheus client to Prometheus in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Scrape to Prometheus Exporter Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_scrape","sink: prometheus_exporter"]
...
send metrics from Prometheus client to Prometheus.
...
<!--
    ...
    guides/integrate/sources/prometheus_scrape/prometheus_exporter.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Collects metrics from [Prometheus client](https://prometheus.io/docs/instrumenting/clientlibs/).
    * Enriches data with useful Prometheus client context.
...
<Tabs
  ...
  groupId="integration-guide-prometheus_scrape.prometheus_exporter_interface"
