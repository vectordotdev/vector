---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus client to Statsd receiver"
description: "A simple guide to send metrics from Prometheus client to Statsd receiver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Scrape to Statsd Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_scrape","sink: statsd"]
...
send metrics from Prometheus client to Statsd receiver.
...
<!--
    ...
    guides/integrate/sources/prometheus_scrape/statsd.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-prometheus_scrape.statsd_interface"
