---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus client to Kafka"
description: "A simple guide to send metrics from Prometheus client to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Scrape to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_scrape","sink: kafka"]
...
send metrics from Prometheus client to Kafka.
...
<!--
    ...
    guides/integrate/sources/prometheus_scrape/kafka.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-prometheus_scrape.kafka_interface"
