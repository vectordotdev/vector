---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus client to Humio"
description: "A simple guide to send metrics from Prometheus client to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Scrape to Humio Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_scrape","sink: humio_metrics"]
...
send metrics from Prometheus client to Humio.
...
<!--
    ...
    guides/integrate/sources/prometheus_scrape/humio_metrics.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends metrics to [Humio](https://humio.com).
...
<Tabs
  ...
  groupId="integration-guide-prometheus_scrape.humio_metrics_interface"
