---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus client to InfluxDB"
description: "A simple guide to send metrics from Prometheus client to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Scrape to InfluxDB Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_scrape","sink: influxdb_metrics"]
...
send metrics from Prometheus client to InfluxDB.
...
<!--
    ...
    guides/integrate/sources/prometheus_scrape/influxdb_metrics.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends metrics to [InfluxDB](https://www.influxdata.com/products/influxdb-overview/).
...
<Tabs
  ...
  groupId="integration-guide-prometheus_scrape.influxdb_metrics_interface"
