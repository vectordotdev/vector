---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus client to AWS Cloudwatch metrics"
description: "A simple guide to send metrics from Prometheus client to AWS Cloudwatch metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Scrape to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_scrape","sink: aws_cloudwatch_metrics"]
...
send metrics from Prometheus client to AWS Cloudwatch metrics.
...
<!--
    ...
    guides/integrate/sources/prometheus_scrape/aws_cloudwatch_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-prometheus_scrape.aws_cloudwatch_metrics_interface"
