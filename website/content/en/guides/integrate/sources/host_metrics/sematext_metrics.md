---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to Sematext"
description: "A simple guide to send metrics from a Host (Node) to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to Sematext Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: sematext_metrics"]
...
send metrics from a Host (Node) to Sematext.
...
<!--
    ...
    guides/integrate/sources/host_metrics/sematext_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.sematext_metrics_interface"
