---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to Kafka"
description: "A simple guide to send metrics from a Host (Node) to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: kafka"]
...
send metrics from a Host (Node) to Kafka.
...
<!--
    ...
    guides/integrate/sources/host_metrics/kafka.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.kafka_interface"
