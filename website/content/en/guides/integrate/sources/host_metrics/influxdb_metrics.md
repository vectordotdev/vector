---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to InfluxDB"
description: "A simple guide to send metrics from a Host (Node) to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to InfluxDB Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: influxdb_metrics"]
...
send metrics from a Host (Node) to InfluxDB.
...
<!--
    ...
    guides/integrate/sources/host_metrics/influxdb_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.influxdb_metrics_interface"
