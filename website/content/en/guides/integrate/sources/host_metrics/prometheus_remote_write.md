---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to Prometheus"
description: "A simple guide to send metrics from a Host (Node) to Prometheus in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to Prometheus Remote Write Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: prometheus_remote_write"]
...
send metrics from a Host (Node) to Prometheus.
...
<!--
    ...
    guides/integrate/sources/host_metrics/prometheus_remote_write.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.prometheus_remote_write_interface"
