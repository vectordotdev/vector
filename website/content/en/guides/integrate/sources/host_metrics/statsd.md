---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to Statsd receiver"
description: "A simple guide to send metrics from a Host (Node) to Statsd receiver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to Statsd Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: statsd"]
...
send metrics from a Host (Node) to Statsd receiver.
...
<!--
    ...
    guides/integrate/sources/host_metrics/statsd.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.statsd_interface"
