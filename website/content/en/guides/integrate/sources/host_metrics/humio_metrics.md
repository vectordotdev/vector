---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to Humio"
description: "A simple guide to send metrics from a Host (Node) to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to Humio Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: humio_metrics"]
...
send metrics from a Host (Node) to Humio.
...
<!--
    ...
    guides/integrate/sources/host_metrics/humio_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.humio_metrics_interface"
