---
$schema: "../../../.schema.json"
title: "Send metrics from a Host (Node) to Datadog metrics"
description: "A simple guide to send metrics from a Host (Node) to Datadog metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Host Metrics to Datadog Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: host_metrics","sink: datadog_metrics"]
...
send metrics from a Host (Node) to Datadog metrics.
...
<!--
    ...
    guides/integrate/sources/host_metrics/datadog_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-host_metrics.datadog_metrics_interface"
