---
$schema: "../../../.schema.json"
title: "Send logs from Syslog to Azure Monitor logs"
description: "A simple guide to send logs from Syslog to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: azure_monitor_logs"]
...
send logs from Syslog to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/syslog/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-syslog.azure_monitor_logs_interface"
