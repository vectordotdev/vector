---
$schema: "../../../.schema.json"
title: "Send logs from Syslog to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from Syslog to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from Syslog to GCP Operations (formerly Stackdriver) logs.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives logs from [Syslog](https://en.wikipedia.org/wiki/Syslog).
...
<Tabs
  ...
  groupId="integration-guide-syslog.gcp_stackdriver_logs_interface"
