---
$schema: "../../../.schema.json"
title: "Send logs from Syslog to AWS Simple Queue Service"
description: "A simple guide to send logs from Syslog to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: aws_sqs"]
...
send logs from Syslog to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/syslog/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-syslog.aws_sqs_interface"
