---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Datadog logs"
description: "A simple guide to send logs from AWS Kinesis Firehose to Datadog logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: datadog_logs"]
...
send logs from AWS Kinesis Firehose to Datadog logs.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/datadog_logs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Datadog logs](https://docs.datadoghq.com/logs/).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.datadog_logs_interface"
