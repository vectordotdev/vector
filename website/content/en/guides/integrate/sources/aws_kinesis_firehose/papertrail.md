---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Papertrail"
description: "A simple guide to send logs from AWS Kinesis Firehose to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: papertrail"]
...
send logs from AWS Kinesis Firehose to Papertrail.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/papertrail.md.erb
-->
...
[Papertrail](https://www.papertrail.com/) is a web-based log aggregation application used by developers and IT team to search and view logs in real time.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Papertrail](https://www.papertrail.com/).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.papertrail_interface"
