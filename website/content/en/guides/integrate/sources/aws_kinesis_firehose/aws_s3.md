---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to AWS S3"
description: "A simple guide to send logs from AWS Kinesis Firehose to AWS S3 in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to AWS S3 Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: aws_s3"]
...
send logs from AWS Kinesis Firehose to AWS S3.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/aws_s3.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.aws_s3_interface"
