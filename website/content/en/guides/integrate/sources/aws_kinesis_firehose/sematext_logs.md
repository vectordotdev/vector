---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Sematext"
description: "A simple guide to send logs from AWS Kinesis Firehose to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: sematext_logs"]
...
send logs from AWS Kinesis Firehose to Sematext.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/sematext_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.sematext_logs_interface"
