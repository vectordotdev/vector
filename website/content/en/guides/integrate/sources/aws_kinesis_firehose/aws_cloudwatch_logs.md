---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to AWS Cloudwatch logs"
description: "A simple guide to send logs from AWS Kinesis Firehose to AWS Cloudwatch logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: aws_cloudwatch_logs"]
...
send logs from AWS Kinesis Firehose to AWS Cloudwatch logs.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/aws_cloudwatch_logs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [AWS Cloudwatch logs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.html).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.aws_cloudwatch_logs_interface"
