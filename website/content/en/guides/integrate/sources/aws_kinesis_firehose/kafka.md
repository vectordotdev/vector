---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Kafka"
description: "A simple guide to send logs from AWS Kinesis Firehose to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: kafka"]
...
send logs from AWS Kinesis Firehose to Kafka.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/kafka.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.kafka_interface"
