---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to GCP PubSub"
description: "A simple guide to send logs from AWS Kinesis Firehose to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: gcp_pubsub"]
...
send logs from AWS Kinesis Firehose to GCP PubSub.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/gcp_pubsub.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.gcp_pubsub_interface"
