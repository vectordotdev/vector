---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Splunk"
description: "A simple guide to send logs from AWS Kinesis Firehose to Splunk in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: splunk_hec"]
...
send logs from AWS Kinesis Firehose to Splunk.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/splunk_hec.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Splunk](https://www.splunk.com).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.splunk_hec_interface"
