---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Elasticsearch"
description: "A simple guide to send logs from AWS Kinesis Firehose to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: elasticsearch"]
...
send logs from AWS Kinesis Firehose to Elasticsearch.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/elasticsearch.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.elasticsearch_interface"
