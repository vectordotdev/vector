---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to NATS"
description: "A simple guide to send logs from AWS Kinesis Firehose to NATS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to NATS Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: nats"]
...
send logs from AWS Kinesis Firehose to NATS.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/nats.md.erb
-->
...
[NATS.io](https://nats.io/) is a simple, secure and high performance open source messaging system for cloud native applications, IoT messaging, and microservices architectures. NATS.io is a Cloud Native Computing Foundation project.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [NATS](https://nats.io/).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.nats_interface"
