---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Apache Pulsar"
description: "A simple guide to send logs from AWS Kinesis Firehose to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: pulsar"]
...
send logs from AWS Kinesis Firehose to Apache Pulsar.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/pulsar.md.erb
-->
...
[Pulsar](https://pulsar.apache.org/) is a multi-tenant, high-performance solution for server-to-server messaging. Pulsar was originally developed by Yahoo, it is under the stewardship of the Apache Software Foundation. It is an excellent tool for streaming logs and metrics data.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Apache Pulsar](https://pulsar.apache.org/).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.pulsar_interface"
