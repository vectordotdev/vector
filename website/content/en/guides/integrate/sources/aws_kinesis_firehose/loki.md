---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Loki"
description: "A simple guide to send logs from AWS Kinesis Firehose to Loki in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: loki"]
...
send logs from AWS Kinesis Firehose to Loki.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/loki.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.loki_interface"
