---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to AWS Kinesis Firehose"
description: "A simple guide to send logs from AWS Kinesis Firehose to AWS Kinesis Firehose in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to AWS Kinesis Firehose Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: aws_kinesis_firehose"]
...
send logs from AWS Kinesis Firehose to AWS Kinesis Firehose.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/aws_kinesis_firehose.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [AWS Kinesis Firehose](https://aws.amazon.com/kinesis/data-firehose/).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.aws_kinesis_firehose_interface"
