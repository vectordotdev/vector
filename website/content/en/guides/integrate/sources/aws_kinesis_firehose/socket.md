---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to socket receiver"
description: "A simple guide to send logs from AWS Kinesis Firehose to socket receiver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: socket"]
...
send logs from AWS Kinesis Firehose to socket receiver.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/socket.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [socket receiver](https://en.wikipedia.org/wiki/Network_socket).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.socket_interface"
