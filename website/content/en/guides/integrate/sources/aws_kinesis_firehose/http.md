---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to HTTP"
description: "A simple guide to send logs from AWS Kinesis Firehose to HTTP in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: http"]
...
send logs from AWS Kinesis Firehose to HTTP.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/http.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.http_interface"
