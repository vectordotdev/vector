---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to GCP Cloud Storage"
description: "A simple guide to send logs from AWS Kinesis Firehose to GCP Cloud Storage in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: gcp_cloud_storage"]
...
send logs from AWS Kinesis Firehose to GCP Cloud Storage.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/gcp_cloud_storage.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [GCP Cloud Storage](https://cloud.google.com/storage).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.gcp_cloud_storage_interface"
