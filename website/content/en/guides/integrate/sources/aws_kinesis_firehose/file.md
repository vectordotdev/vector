---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to File"
description: "A simple guide to send logs from AWS Kinesis Firehose to File in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to File Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: file"]
...
send logs from AWS Kinesis Firehose to File.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/file.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.file_interface"
