---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to InfluxDB"
description: "A simple guide to send logs from AWS Kinesis Firehose to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: influxdb_logs"]
...
send logs from AWS Kinesis Firehose to InfluxDB.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/influxdb_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.influxdb_logs_interface"
