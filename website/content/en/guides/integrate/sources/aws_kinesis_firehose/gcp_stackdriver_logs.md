---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from AWS Kinesis Firehose to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to GCP Operations (formerly Stackdrive) Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: gcp_stackdriver_logs"]
...
send logs from AWS Kinesis Firehose to GCP Operations (formerly Stackdriver) logs.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/gcp_stackdriver_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.gcp_stackdriver_logs_interface"
