---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Azure Monitor logs"
description: "A simple guide to send logs from AWS Kinesis Firehose to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: azure_monitor_logs"]
...
send logs from AWS Kinesis Firehose to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.azure_monitor_logs_interface"
