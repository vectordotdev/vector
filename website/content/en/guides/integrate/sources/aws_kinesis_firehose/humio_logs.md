---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to Humio"
description: "A simple guide to send logs from AWS Kinesis Firehose to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: humio_logs"]
...
send logs from AWS Kinesis Firehose to Humio.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/humio_logs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [Humio](https://humio.com).
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.humio_logs_interface"
