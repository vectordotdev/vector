---
$schema: "../../../.schema.json"
title: "Send logs from AWS Kinesis Firehose to LogDNA"
description: "A simple guide to send logs from AWS Kinesis Firehose to LogDNA in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Kinesis Firehose to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_kinesis_firehose","sink: logdna"]
...
send logs from AWS Kinesis Firehose to LogDNA.
...
<!--
    ...
    guides/integrate/sources/aws_kinesis_firehose/logdna.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_kinesis_firehose.logdna_interface"
