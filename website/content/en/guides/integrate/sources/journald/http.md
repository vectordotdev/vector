...
description: "A simple guide to send logs from JournalD to HTTP in just a few minutes."
...
send logs from JournalD to HTTP.
...
<Tabs
  ...
  groupId="integration-guide-journald.http_interface"
