...
send logs from JournalD to Clickhouse.
...
[Journald](https://www.freedesktop.org/software/systemd/man/systemd-journald.service.html) is a utility for accessing log data across a variety of system services. It was introduced with [Systemd](https://systemd.io/) to help system administrators collect, access, and route log data.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Collects logs from [JournalD](https://www.freedesktop.org/software/systemd/man/systemd-journald.service.html).
...
<Tabs
  ...
  groupId="integration-guide-journald.clickhouse_interface"
