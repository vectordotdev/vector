---
$schema: "../../../.schema.json"
title: "Send logs from JournalD to Azure Monitor logs"
description: "A simple guide to send logs from JournalD to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: azure_monitor_logs"]
...
send logs from JournalD to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/journald/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-journald.azure_monitor_logs_interface"
