---
$schema: "../../../.schema.json"
title: "Send logs from JournalD to AWS Simple Queue Service"
description: "A simple guide to send logs from JournalD to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: aws_sqs"]
...
send logs from JournalD to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/journald/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-journald.aws_sqs_interface"
