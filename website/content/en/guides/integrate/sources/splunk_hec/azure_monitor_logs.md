---
$schema: "../../../.schema.json"
title: "Send logs from Splunk to Azure Monitor logs"
description: "A simple guide to send logs from Splunk to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HTTP Event Collector (HEC) to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: azure_monitor_logs"]
...
send logs from Splunk to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/splunk_hec/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-splunk_hec.azure_monitor_logs_interface"
