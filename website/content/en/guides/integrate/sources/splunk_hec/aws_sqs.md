---
$schema: "../../../.schema.json"
title: "Send logs from Splunk to AWS Simple Queue Service"
description: "A simple guide to send logs from Splunk to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HTTP Event Collector (HEC) to Amazon Simple Queue Service (SQS) Integration"
...
send logs from Splunk to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/splunk_hec/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-splunk_hec.aws_sqs_interface"
