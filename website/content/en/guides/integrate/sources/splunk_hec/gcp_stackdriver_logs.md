---
$schema: "../../../.schema.json"
title: "Send logs from Splunk to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from Splunk to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HTTP Event Collector (HEC) to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from Splunk to GCP Operations (formerly Stackdriver) logs.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives logs from [Splunk](https://www.splunk.com).
    * Enriches data with useful Splunk context.
...
<Tabs
  ...
  groupId="integration-guide-splunk_hec.gcp_stackdriver_logs_interface"
