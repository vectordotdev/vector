---
$schema: "../../../.schema.json"
title: "Send metrics from Nginx to Prometheus"
description: "A simple guide to send metrics from Nginx to Prometheus in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Nginx Metrics to Prometheus Remote Write Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: nginx_metrics","sink: prometheus_remote_write"]
...
send metrics from Nginx to Prometheus.
...
<!--
    ...
    guides/integrate/sources/nginx_metrics/prometheus_remote_write.md.erb
-->
...
[Nginx][urls.nginx] is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Collects metrics from [Nginx](https://www.nginx.com/).
...
<Tabs
  ...
  groupId="integration-guide-nginx_metrics.prometheus_remote_write_interface"
