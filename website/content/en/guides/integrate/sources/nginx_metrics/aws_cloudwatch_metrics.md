---
$schema: "../../../.schema.json"
title: "Send metrics from Nginx to AWS Cloudwatch metrics"
description: "A simple guide to send metrics from Nginx to AWS Cloudwatch metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Nginx Metrics to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: nginx_metrics","sink: aws_cloudwatch_metrics"]
...
send metrics from Nginx to AWS Cloudwatch metrics.
...
<!--
    ...
    guides/integrate/sources/nginx_metrics/aws_cloudwatch_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-nginx_metrics.aws_cloudwatch_metrics_interface"
