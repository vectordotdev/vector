---
$schema: "../../../.schema.json"
title: "Send metrics from PostgreSQL Server to Datadog metrics"
description: "A simple guide to send metrics from PostgreSQL Server to Datadog metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "PostgreSQL Metrics to Datadog Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: postgresql_metrics","sink: datadog_metrics"]
...
send metrics from PostgreSQL Server to Datadog metrics.
...
<!--
    ...
    guides/integrate/sources/postgresql_metrics/datadog_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-postgresql_metrics.datadog_metrics_interface"
