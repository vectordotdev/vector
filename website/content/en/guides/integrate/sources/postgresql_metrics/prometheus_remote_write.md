---
$schema: "../../../.schema.json"
title: "Send metrics from PostgreSQL Server to Prometheus"
description: "A simple guide to send metrics from PostgreSQL Server to Prometheus in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "PostgreSQL Metrics to Prometheus Remote Write Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: postgresql_metrics","sink: prometheus_remote_write"]
...
send metrics from PostgreSQL Server to Prometheus.
...
<!--
    ...
    guides/integrate/sources/postgresql_metrics/prometheus_remote_write.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-postgresql_metrics.prometheus_remote_write_interface"
