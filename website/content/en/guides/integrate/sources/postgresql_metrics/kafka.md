---
$schema: "../../../.schema.json"
title: "Send metrics from PostgreSQL Server to Kafka"
description: "A simple guide to send metrics from PostgreSQL Server to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "PostgreSQL Metrics to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: postgresql_metrics","sink: kafka"]
...
send metrics from PostgreSQL Server to Kafka.
...
<!--
    ...
    guides/integrate/sources/postgresql_metrics/kafka.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-postgresql_metrics.kafka_interface"
