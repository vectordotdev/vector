---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to Splunk"
description: "A simple guide to send logs from Heroku to Splunk in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: splunk_hec"]
...
send logs from Heroku to Splunk.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/splunk_hec.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.splunk_hec_interface"
