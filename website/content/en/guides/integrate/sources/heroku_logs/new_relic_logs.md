---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to New Relic logs"
description: "A simple guide to send logs from Heroku to New Relic logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: new_relic_logs"]
...
send logs from Heroku to New Relic logs.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/new_relic_logs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [New Relic logs](https://newrelic.com/).
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.new_relic_logs_interface"
