---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to GCP Cloud Storage"
description: "A simple guide to send logs from Heroku to GCP Cloud Storage in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: gcp_cloud_storage"]
...
send logs from Heroku to GCP Cloud Storage.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/gcp_cloud_storage.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.gcp_cloud_storage_interface"
