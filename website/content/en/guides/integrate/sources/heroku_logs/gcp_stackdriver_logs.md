---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from Heroku to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to GCP Operations (formerly Stackdrive) Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: gcp_stackdriver_logs"]
...
send logs from Heroku to GCP Operations (formerly Stackdriver) logs.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/gcp_stackdriver_logs.md.erb
-->
...
[Heroku](https://www.heroku.com) is a container-based platform for deploying and
...
### What is GCP Operations (formerly Stackdriver) logs?

[Stackdriver][urls.gcp_stackdriver] is Google Cloud's embedded observability suite designed to monitor, troubleshoot, and improve cloud infrastructure, software and application performance. Stackdriver enables you to efficiently build and run workloads, keeping applications available and performing well.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives log data from Heroku log drains via Heroku's logplex system.
    * Enriches data with useful Heroku context.
    * Securely receives data via Transport Layer Security (TLS).
  * Sends logs to [GCP Operations (formerly Stackdriver) logs](https://cloud.google.com/logging/docs/reference/v2/rest/).
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.gcp_stackdriver_logs_interface"
