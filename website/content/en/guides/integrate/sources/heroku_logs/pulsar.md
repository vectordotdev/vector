---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to Apache Pulsar"
description: "A simple guide to send logs from Heroku to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: pulsar"]
...
send logs from Heroku to Apache Pulsar.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/pulsar.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.pulsar_interface"
