---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to AWS Simple Queue Service"
description: "A simple guide to send logs from Heroku to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: aws_sqs"]
...
send logs from Heroku to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.aws_sqs_interface"
