---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to socket receiver"
description: "A simple guide to send logs from Heroku to socket receiver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: socket"]
...
send logs from Heroku to socket receiver.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/socket.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.socket_interface"
