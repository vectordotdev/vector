---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to Azure Monitor logs"
description: "A simple guide to send logs from Heroku to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: azure_monitor_logs"]
...
send logs from Heroku to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.azure_monitor_logs_interface"
