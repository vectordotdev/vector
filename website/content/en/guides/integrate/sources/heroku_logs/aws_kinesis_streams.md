---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to AWS Kinesis Data Streams"
description: "A simple guide to send logs from Heroku to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: aws_kinesis_streams"]
...
send logs from Heroku to AWS Kinesis Data Streams.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/aws_kinesis_streams.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.aws_kinesis_streams_interface"
