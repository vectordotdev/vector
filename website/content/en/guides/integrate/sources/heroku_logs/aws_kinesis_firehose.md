---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to AWS Kinesis Firehose"
description: "A simple guide to send logs from Heroku to AWS Kinesis Firehose in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to AWS Kinesis Firehose Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: aws_kinesis_firehose"]
...
send logs from Heroku to AWS Kinesis Firehose.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/aws_kinesis_firehose.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.aws_kinesis_firehose_interface"
