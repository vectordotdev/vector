---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to AWS Cloudwatch logs"
description: "A simple guide to send logs from Heroku to AWS Cloudwatch logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: aws_cloudwatch_logs"]
...
send logs from Heroku to AWS Cloudwatch logs.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/aws_cloudwatch_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.aws_cloudwatch_logs_interface"
