---
$schema: "../../../.schema.json"
title: "Send logs from Heroku to Kafka"
description: "A simple guide to send logs from Heroku to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: heroku_logs","sink: kafka"]
...
send logs from Heroku to Kafka.
...
<!--
    ...
    guides/integrate/sources/heroku_logs/kafka.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-heroku_logs.kafka_interface"
