---
$schema: "../../../.schema.json"
title: "Send logs from files to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from files to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from files to GCP Operations (formerly Stackdriver) logs.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Collects logs from [files](https://en.wikipedia.org/wiki/File_system).
...
<Tabs
  ...
  groupId="integration-guide-file.gcp_stackdriver_logs_interface"
