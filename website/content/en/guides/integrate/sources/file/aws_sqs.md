---
$schema: "../../../.schema.json"
title: "Send logs from files to AWS Simple Queue Service"
description: "A simple guide to send logs from files to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: aws_sqs"]
...
send logs from files to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/file/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-file.aws_sqs_interface"
