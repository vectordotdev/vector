---
$schema: "../../../.schema.json"
title: "Send logs from files to HTTP"
description: "A simple guide to send logs from files to HTTP in just a few minutes."
...
<Tabs
  ...
  groupId="integration-guide-file.http_interface"
