---
$schema: "../../../.schema.json"
title: "Send logs from socket client to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from socket client to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from socket client to GCP Operations (formerly Stackdriver) logs.
...
<Tabs
  ...
  groupId="integration-guide-socket.gcp_stackdriver_logs_interface"
