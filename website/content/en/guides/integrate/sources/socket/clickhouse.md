---
$schema: "../../../.schema.json"
title: "Send logs from socket client to Clickhouse"
description: "A simple guide to send logs from socket client to Clickhouse in just a few minutes."
...
send logs from socket client to Clickhouse.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives logs from [socket client](https://en.wikipedia.org/wiki/Network_socket).
    * Enriches data with useful socket client context.
...
<Tabs
  ...
  groupId="integration-guide-socket.clickhouse_interface"
