---
$schema: "../../../.schema.json"
title: "Send logs from socket client to NATS"
description: "A simple guide to send logs from socket client to NATS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to NATS Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: nats"]
...
send logs from socket client to NATS.
...
<!--
    ...
    guides/integrate/sources/socket/nats.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-socket.nats_interface"
