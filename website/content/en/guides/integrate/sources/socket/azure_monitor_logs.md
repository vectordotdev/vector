---
$schema: "../../../.schema.json"
title: "Send logs from socket client to Azure Monitor logs"
description: "A simple guide to send logs from socket client to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: azure_monitor_logs"]
...
send logs from socket client to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/socket/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-socket.azure_monitor_logs_interface"
