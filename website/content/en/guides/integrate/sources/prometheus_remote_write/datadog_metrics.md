---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus to Datadog metrics"
description: "A simple guide to send metrics from Prometheus to Datadog metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Remote Write to Datadog Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_remote_write","sink: datadog_metrics"]
...
send metrics from Prometheus to Datadog metrics.
...
<!--
    ...
    guides/integrate/sources/prometheus_remote_write/datadog_metrics.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends metrics to [Datadog metrics](https://docs.datadoghq.com/metrics/).
...
<Tabs
  ...
  groupId="integration-guide-prometheus_remote_write.datadog_metrics_interface"
