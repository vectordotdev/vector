---
$schema: "../../../.schema.json"
title: "Send metrics from Prometheus to AWS Cloudwatch metrics"
description: "A simple guide to send metrics from Prometheus to AWS Cloudwatch metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Prometheus Remote Write to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: prometheus_remote_write","sink: aws_cloudwatch_metrics"]
...
send metrics from Prometheus to AWS Cloudwatch metrics.
...
<!--
    ...
    guides/integrate/sources/prometheus_remote_write/aws_cloudwatch_metrics.md.erb
-->
...
<DaemonDiagram
  platformName={null}
  sourceName={"prometheus_remote_write"}
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives metrics from [Prometheus](https://prometheus.io/).
    * Enriches data with useful Prometheus context.
    * Securely receives data via Transport Layer Security (TLS).
  * Sends metrics to [AWS Cloudwatch metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/working_with_metrics.html).
...
<Tabs
  ...
  groupId="integration-guide-prometheus_remote_write.aws_cloudwatch_metrics_interface"
