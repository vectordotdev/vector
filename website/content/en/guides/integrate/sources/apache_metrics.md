---
$schema: "../../.schema.json"
title: "Send metrics from Apache HTTP server (HTTPD) to anywhere"
description: "A simple guide to send metrics from Apache HTTP server (HTTPD) to anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Apache HTTP Server (HTTPD) Metrics Integration"
tags: ["type: tutorial","domain: sources","source: apache_metrics"]
...
send metrics from Apache HTTP server (HTTPD) to anywhere.
...
<!--
    ...
    guides/integrate/sources/apache_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-apache_metrics_interface"
