---
$schema: "../../../.schema.json"
title: "Send logs from Kafka to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from Kafka to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from Kafka to GCP Operations (formerly Stackdriver) logs.
...
<Tabs
  ...
  groupId="integration-guide-kafka.gcp_stackdriver_logs_interface"
