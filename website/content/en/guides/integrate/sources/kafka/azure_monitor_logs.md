---
$schema: "../../../.schema.json"
title: "Send logs from Kafka to Azure Monitor logs"
description: "A simple guide to send logs from Kafka to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: azure_monitor_logs"]
...
send logs from Kafka to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/kafka/azure_monitor_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-kafka.azure_monitor_logs_interface"
