---
$schema: "../../../.schema.json"
title: "Send logs from Kafka to AWS Simple Queue Service"
description: "A simple guide to send logs from Kafka to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: aws_sqs"]
...
send logs from Kafka to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/kafka/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-kafka.aws_sqs_interface"
