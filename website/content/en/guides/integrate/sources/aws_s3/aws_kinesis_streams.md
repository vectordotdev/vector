---
$schema: "../../../.schema.json"
title: "Send logs from AWS S3 to AWS Kinesis Data Streams"
description: "A simple guide to send logs from AWS S3 to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS S3 to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_s3","sink: aws_kinesis_streams"]
...
send logs from AWS S3 to AWS Kinesis Data Streams.
...
<!--
    ...
    guides/integrate/sources/aws_s3/aws_kinesis_streams.md.erb
-->
...
[Amazon Simple Storage Service (Amazon S3)](https://aws.amazon.com/s3/) is a scalable, high-speed, web-based cloud storage service designed for online backup and archiving of data and applications on Amazon Web Services. It is very commonly used to store log data.

### What is AWS Kinesis Data Streams?

[Amazon Kinesis Data Streams](https://aws.amazon.com/kinesis/data-streams/) is a scalable and durable real-time data streaming service that can continuously capture gigabytes of data per second from hundreds of thousands of sources. Making it an excellent candidate for streaming logs and metrics data.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Collects logs from [AWS S3](https://aws.amazon.com/s3/).
  ...
  * Sends logs to [AWS Kinesis Data Streams](https://aws.amazon.com/kinesis/data-streams/).
...
<Tabs
  ...
  groupId="integration-guide-aws_s3.aws_kinesis_streams_interface"
