---
$schema: "../../../.schema.json"
title: "Send logs from AWS S3 to GCP Cloud Storage"
description: "A simple guide to send logs from AWS S3 to GCP Cloud Storage in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS S3 to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_s3","sink: gcp_cloud_storage"]
...
send logs from AWS S3 to GCP Cloud Storage.
...
<!--
    ...
    guides/integrate/sources/aws_s3/gcp_cloud_storage.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_s3.gcp_cloud_storage_interface"
