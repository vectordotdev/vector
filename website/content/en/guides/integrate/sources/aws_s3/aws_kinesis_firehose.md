---
$schema: "../../../.schema.json"
title: "Send logs from AWS S3 to AWS Kinesis Firehose"
description: "A simple guide to send logs from AWS S3 to AWS Kinesis Firehose in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS S3 to AWS Kinesis Firehose Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_s3","sink: aws_kinesis_firehose"]
...
send logs from AWS S3 to AWS Kinesis Firehose.
...
<!--
    ...
    guides/integrate/sources/aws_s3/aws_kinesis_firehose.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_s3.aws_kinesis_firehose_interface"
