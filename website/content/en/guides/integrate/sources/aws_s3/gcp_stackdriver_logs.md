---
$schema: "../../../.schema.json"
title: "Send logs from AWS S3 to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from AWS S3 to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS S3 to GCP Operations (formerly Stackdrive) Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_s3","sink: gcp_stackdriver_logs"]
...
send logs from AWS S3 to GCP Operations (formerly Stackdriver) logs.
...
<!--
    ...
    guides/integrate/sources/aws_s3/gcp_stackdriver_logs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_s3.gcp_stackdriver_logs_interface"
