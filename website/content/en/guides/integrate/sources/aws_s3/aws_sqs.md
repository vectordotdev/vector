---
$schema: "../../../.schema.json"
title: "Send logs from AWS S3 to AWS Simple Queue Service"
description: "A simple guide to send logs from AWS S3 to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS S3 to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_s3","sink: aws_sqs"]
...
send logs from AWS S3 to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/aws_s3/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_s3.aws_sqs_interface"
