---
$schema: "../../.schema.json"
title: "Send logs from socket client to anywhere"
description: "A simple guide to send logs from socket client to anywhere in just a few minutes."
...
send logs from socket client to anywhere.
