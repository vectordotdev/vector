---
$schema: "../../../.schema.json"
title: "Send metrics from Amazon ECS to AWS Cloudwatch metrics"
description: "A simple guide to send metrics from Amazon ECS to AWS Cloudwatch metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS ECS Metrics to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: aws_ecs_metrics","sink: aws_cloudwatch_metrics"]
...
send metrics from Amazon ECS to AWS Cloudwatch metrics.
...
<!--
    ...
    guides/integrate/sources/aws_ecs_metrics/aws_cloudwatch_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-aws_ecs_metrics.aws_cloudwatch_metrics_interface"
