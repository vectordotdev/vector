---
$schema: "../../../.schema.json"
title: "Send metrics from MongoDB to Prometheus"
description: "A simple guide to send metrics from MongoDB to Prometheus in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "MongoDB Metrics to Prometheus Remote Write Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: mongodb_metrics","sink: prometheus_remote_write"]
...
<!--
    ...
    guides/integrate/sources/mongodb_metrics/prometheus_remote_write.md.erb
-->
...
[MongoDB][urls.mongodb] is a general purpose, document-based, distributed database built for modern application developers and for the cloud era.
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Collects metrics from [MongoDB](https://www.mongodb.com).
...
<Tabs
  ...
  groupId="integration-guide-mongodb_metrics.prometheus_remote_write_interface"
