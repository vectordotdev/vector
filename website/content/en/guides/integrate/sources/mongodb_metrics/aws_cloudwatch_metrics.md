---
$schema: "../../../.schema.json"
title: "Send metrics from MongoDB to AWS Cloudwatch metrics"
description: "A simple guide to send metrics from MongoDB to AWS Cloudwatch metrics in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "MongoDB Metrics to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: mongodb_metrics","sink: aws_cloudwatch_metrics"]
...
send metrics from MongoDB to AWS Cloudwatch metrics.
...
<!--
    ...
    guides/integrate/sources/mongodb_metrics/aws_cloudwatch_metrics.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-mongodb_metrics.aws_cloudwatch_metrics_interface"
