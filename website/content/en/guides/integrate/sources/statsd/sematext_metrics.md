---
$schema: "../../../.schema.json"
title: "Send metrics from StatsD to Sematext"
description: "A simple guide to send metrics from StatsD to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "StatsD to Sematext Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: statsd","sink: sematext_metrics"]
...
send metrics from StatsD to Sematext.
...
<!--
    ...
    guides/integrate/sources/statsd/sematext_metrics.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives metrics from [StatsD](https://github.com/statsd/statsd).
...
<Tabs
  ...
  groupId="integration-guide-statsd.sematext_metrics_interface"
