---
$schema: "../../../.schema.json"
title: "Send logs from STDIN to GCP Operations (formerly Stackdriver) logs"
description: "A simple guide to send logs from STDIN to GCP Operations (formerly Stackdriver) logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to GCP Operations (formerly Stackdrive) Logs Integration"
...
send logs from STDIN to GCP Operations (formerly Stackdriver) logs.
...
<Tabs
  ...
  groupId="integration-guide-stdin.gcp_stackdriver_logs_interface"
