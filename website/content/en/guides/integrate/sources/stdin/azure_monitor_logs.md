---
$schema: "../../../.schema.json"
title: "Send logs from STDIN to Azure Monitor logs"
description: "A simple guide to send logs from STDIN to Azure Monitor logs in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Azure Monitor Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: azure_monitor_logs"]
...
send logs from STDIN to Azure Monitor logs.
...
<!--
    ...
    guides/integrate/sources/stdin/azure_monitor_logs.md.erb
-->
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Receives logs from [STDIN](https://en.wikipedia.org/wiki/Standard_streams#Standard_input_(stdin)).
    * Enriches data with useful STDIN context.
...
<Tabs
  ...
  groupId="integration-guide-stdin.azure_monitor_logs_interface"
