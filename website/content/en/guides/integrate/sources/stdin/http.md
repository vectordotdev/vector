...
description: "A simple guide to send logs from STDIN to HTTP in just a few minutes."
...
<div className="list--icons list--icons--checks list--indent">
  ...
  * Sends logs to [HTTP](https://en.wikipedia.org/wiki/Web_server).
...
<Tabs
  ...
  groupId="integration-guide-stdin.http_interface"
