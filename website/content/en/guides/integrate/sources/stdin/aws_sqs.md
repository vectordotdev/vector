---
$schema: "../../../.schema.json"
title: "Send logs from STDIN to AWS Simple Queue Service"
description: "A simple guide to send logs from STDIN to AWS Simple Queue Service in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Amazon Simple Queue Service (SQS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: aws_sqs"]
...
send logs from STDIN to AWS Simple Queue Service.
...
<!--
    ...
    guides/integrate/sources/stdin/aws_sqs.md.erb
-->
...
<Tabs
  ...
  groupId="integration-guide-stdin.aws_sqs_interface"
