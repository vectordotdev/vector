...
* The [Hugo] static site generator (version 0.155.3 to match CI). 
  * Download the **extended** version for your platform from https://github.com/gohugoio/hugo/releases/tag/v0.155.3
