...
The Vector `vector` source ingests data through another upstream [`vector` sink][docs.sources.vector] and outputs [`log`][docs.data-model.log] and [`metric`][docs.data-model.metric] events.
