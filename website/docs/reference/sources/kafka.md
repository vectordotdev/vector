...
The Vector `kafka` source ingests data through Kafka 0.9 or later and [outputs `log` events](#output).
...
The `kafka` source ingests data through Kafka 0.9 or later and [outputs `log` events](#output).
For example:
