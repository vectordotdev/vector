...
description: "The Vector `tcp` source ingests data through the TCP protocol and outputs `log` events."
event_types: ["log"]
...
The Vector `tcp` source ingests data through the TCP protocol and outputs [`log`][docs.data-model.log] events.
...
<!--
     ...
     website/docs/reference/sources/tcp.md.erb
-->
