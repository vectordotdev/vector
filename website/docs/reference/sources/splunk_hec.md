...
<Field
  ...
  type={"bool"}
  unit={null}
  warnings={[{"visibility_level":"option","text":"Setting this to `tru` will cause OpenSSL to not request a certificate from the client","option":"#<Field:0x00005614a14a44d8>"}]}
  >
