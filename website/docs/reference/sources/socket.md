...
The `socket` source ingests data through a [socket][urls.socket], such as a [TCP][urls.tcp], [UDP][urls.udp], or [UDS][urls.uds] socket and outputs [`log`][docs.data-model.log] events.
For example:
