...
The Vector `http` source ingests data through the HTTP protocol and outputs [`log`][docs.data-model.log] events.
...
The `http` source ingests data through the HTTP protocol and outputs [`log`][docs.data-model.log] events.
For example:
