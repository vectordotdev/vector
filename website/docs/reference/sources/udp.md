...
description: "The Vector `udp` source ingests data through the UDP protocol and outputs `log` events."
event_types: ["log"]
...
The Vector `udp` source ingests data through the UDP protocol and outputs [`log`][docs.data-model.log] events.
