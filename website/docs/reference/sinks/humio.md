...
description: "The Vector `humio` sink batches `log` events to Humio via the HEC API."
event_types: ["log"]
issues_url: https://github.com/timberio/vector/issues?q=is%3Aopen+is%3Aissue+label%3A%22sink%3A+humio%22
operating_systems: ["Linux","MacOS","Windows"]
sidebar_label: "humio|[\"log\"]"
source_url: https://github.com/timberio/vector/tree/master/src/sinks/humio.rs
status: "beta"
title: "Humio Sink"
unsupported_operating_systems: []
---

The Vector `humio` sink [batches](#buffers--batches) [`log`][docs.data-model.log] events to [Humio][urls.humio] via the [HEC API][urls.humio_hec].
...
<!--
     ...
     website/docs/reference/sinks/humio.md.erb
-->
...
The `humio` sink buffers & batches data as
...
with the Vector team by [opening an issie][urls.new_humio_sink_issue].
...
[urls.new_humio_sink_issue]: https://github.com/timberio/vector/issues/new?labels=sink%3A+humio
