...
The Vector `papertrail` sink [streams](#streaming) [`log`][docs.data-model.log] events to [Papertrail](https://www.papertrail.com/) via [Syslog](https://help.papertrailapp.com/kb/how-it-works/http-api/#submitting-log-messages).
...
The endpoint to stream logs to. See [Obtaining a Log Destination](#obtaining-a-log-destination) for more info.
