...
description: "The Vector `influxdb_metrics` sink batches `metric` events to InfluxDB using HTTP API."
event_types: ["metric"]
...
status: "beta"
title: "InfluxDB 2 Metrics Sink"
unsupported_operating_systems: []
---

The Vector `influxdb_metrics` sink [batches](#buffers--batches) [`metric`][docs.data-model.metric] events to [InfluxDB][urls.influxdb] using [HTTP API](https://v2.docs.influxdata.com/v2.0/api/#tag/Write).
...
[sinks.my_sink_id]
  ...
  host = "https://us-west-2-1.aws.cloud2.influxdata.com" # example
...
InfluxDB [authentication token](https://v2.docs.influxdata.com/v2.0/security/tokens/)
...
[urls.influxdb]: https://www.influxdata.com
