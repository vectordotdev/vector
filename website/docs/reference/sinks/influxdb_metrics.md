...
The Vector `influxdb_metrics` sink [batches](#buffers--batches) [`metric`][docs.data-model.metric] events to [InfluxDB][urls.influxdb] using [v1][urls.influxdb_http_api_v1] or [v2][urls.influxdb_http_api_v2] HTTP API.
