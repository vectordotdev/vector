...
description: "The Vector `datadog_logs` sink streams `log` events to Datadog's logs."
event_types: ["log"]
...
The Vector `datadog_logs` sink [streams](#streaming) [`log`][docs.data-model.log] events to [Datadog's][urls.datadog] logs.
...
[sinks.my_sink_id]
  # REQUIRED - General
  type = "datadog_logs" # must be: "datadog_logs"
  ...
  # OPTIONAL - General
  endpoint = "intake.logs.datadoghq.com:10516" # default
