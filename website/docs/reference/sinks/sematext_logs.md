...
The Vector `sematext_logs` sink [batches](#buffers--batches) [`log`][docs.data-model.log] events to [Sematext][urls.sematext] via the [Elasticsearch API][urls.sematext_es].
...
[sinks.my_sink_id]
  ...
  [sinks.my_sink_id.encoding]
    ...
    format = "default" # default, must be:  (if supplied)
