...
description: "The `gcp_pubsub` sink batches `log` events to Pubsub via the REST Interface."
event_types: ["log"]
...
status: "beta"
title: "gcp_pubsub sink"
unsupported_operating_systems: []
---

The `gcp_pubsub` sink [batches](#buffers--batches) [`log`][docs.data-model.log] events to [Pubsub][urls.gcp_pubsub] via the [REST Interface][urls.gcp_pubsub_rest].
