---
description: "The [`geoip`](#geoip) transform accepts `log` events and allows you to enrich events with geolocation data from the MaxMind GeoIP2 and GeoLite2 city databases."
event_types: ["log"]
