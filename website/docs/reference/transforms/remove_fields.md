---
description: "The Vector `remove_fields` transform accepts `log` events and allows you to remove one or more log fields."
event_types: ["log"]
...
The Vector `remove_fields` transform accepts [`log`][docs.data-model.log] events and allows you to remove one or more log fields.
