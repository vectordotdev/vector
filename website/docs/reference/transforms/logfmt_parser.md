---
description: "The Vector `logfmt_parser` transform accepts `log` events and allows you to extract data from a logfmt-formatted log field."
event_types: ["log"]
...
The Vector `logfmt_parser` transform accepts [`log`][docs.data-model.log] events and allows you to extract data from a logfmt-formatted log field.
