...
The Vector `log_to_metric` transform accepts [`log`][docs.data-model.log] events but outputs [`metric`][docs.data-model.metric] events allowing you to convert logs into one or more metrics.
