...
The Vector `regex_parser` transform accepts and outputs [`log`][docs.data-model.log] events allowing you to parse a log field's value with a [Regular Expression][urls.regex].
