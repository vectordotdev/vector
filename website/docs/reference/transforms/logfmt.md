---
description: "The Vector `logfmt` transform accepts `log` events and allows you to extract data from a logfmt-formatted log field."
event_types: ["log"]
issues_url: https://github.com/timberio/vector/issues?q=is%3Aopen+is%3Aissue+label%3A%22transform%3A+logfmt%22
sidebar_label: "logfmt|[\"log\"]"
source_url: https://github.com/timberio/vector/tree/master/src/transforms/logfmt.rs
status: "prod-ready"
title: "Logfmt Parser Transform"
---

The Vector `logfmt` transform accepts [`log`][docs.data-model.log] events and allows you to extract data from a logfmt-formatted log field.
...
<!--
     ...
     website/docs/reference/transforms/logfmt.md.erb
-->
