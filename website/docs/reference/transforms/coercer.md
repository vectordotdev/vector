---
description: "The Vector `coercer` transform accepts `log` events and allows you to coerce log fields into fixed types."
event_types: ["log"]
...
The Vector `coercer` transform accepts [`log`][docs.data-model.log] events and allows you to coerce log fields into fixed types.
