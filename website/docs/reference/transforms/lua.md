...
| [`Array`][docs.about.data-model.log#arrays] | [`sequence`][urls.lua_sequence] | Sequences are a special case of tables. The indexes start from 1, following the Lua convention. |
