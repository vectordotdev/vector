...
The Vector `split` transform accepts and outputs [`log`][docs.data-model.log] events allowing you to split a field's value on a given separator and zip the tokens into ordered field names.
