---
description: "The Vector `grok_parser` transform accepts `log` events and allows you to parse a log field value with Grok."
event_types: ["log"]
...
The Vector `grok_parser` transform accepts [`log`][docs.data-model.log] events and allows you to parse a log field value with [Grok][urls.grok].
