...
[`--config` flag][docs.process-management#flags] when [starting][docs.process-management#starting] vector:
...
<!--
     ...
     scripts/generate/templates/website/docs/setup/configuration.md.erb
-->
