...
1. Install Rust using [`rustup`][urls.rustup]. It would install toolchain for `x86_64-pc-windows-msvc` target on 64-bit machines by default. If you don't have VC++ build tools, the installer would prompt you to install them.
