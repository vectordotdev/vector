---
id: file_to_aws_kinesis_firehose
...
keywords: ["file","aws kinesis firehose"]
---

In this guide we'll be consuming `file` logs and writing them to a `aws_kinesis_firehose` sink.
