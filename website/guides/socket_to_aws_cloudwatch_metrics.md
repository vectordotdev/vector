---
id: socket_to_aws_cloudwatch_metrics
...
keywords: ["socket","aws cloudwatch metrics"]
---

In this guide we'll be consuming `socket` logs and writing them to a `aws_cloudwatch_metrics` sink.
