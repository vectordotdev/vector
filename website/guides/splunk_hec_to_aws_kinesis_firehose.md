---
id: splunk_hec_to_aws_kinesis_firehose
...
keywords: ["splunk hec","aws kinesis firehose"]
---

In this guide we'll be consuming `splunk_hec` logs and writing them to a `aws_kinesis_firehose` sink.
