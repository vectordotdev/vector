---
id: kafka_to_aws_kinesis_firehose
...
keywords: ["kafka","aws kinesis firehose"]
---

In this guide we'll be consuming `kafka` logs and writing them to a `aws_kinesis_firehose` sink.
