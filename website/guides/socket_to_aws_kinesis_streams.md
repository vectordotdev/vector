---
id: socket_to_aws_kinesis_streams
...
keywords: ["socket","aws kinesis data streams"]
---

In this guide we'll be consuming `socket` logs and writing them to a `aws_kinesis_streams` sink.
