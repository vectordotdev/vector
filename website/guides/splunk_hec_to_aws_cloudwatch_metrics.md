---
id: splunk_hec_to_aws_cloudwatch_metrics
...
keywords: ["splunk hec","aws cloudwatch metrics"]
---

In this guide we'll be consuming `splunk_hec` logs and writing them to a `aws_cloudwatch_metrics` sink.
