---
id: docker_to_aws_kinesis_firehose
...
keywords: ["docker","aws kinesis firehose"]
---

In this guide we'll be consuming `docker` logs and writing them to a `aws_kinesis_firehose` sink.
