---
id: socket_to_aws_cloudwatch_logs
...
keywords: ["socket","aws cloudwatch logs"]
---

In this guide we'll be consuming `socket` logs and writing them to a `aws_cloudwatch_logs` sink.
