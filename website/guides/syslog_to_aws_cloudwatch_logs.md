---
id: syslog_to_aws_cloudwatch_logs
...
keywords: ["syslog","aws cloudwatch logs"]
---

In this guide we'll be consuming `syslog` logs and writing them to a `aws_cloudwatch_logs` sink.
