---
id: journald_to_aws_kinesis_streams
...
keywords: ["journald","aws kinesis data streams"]
---

In this guide we'll be consuming `journald` logs and writing them to a `aws_kinesis_streams` sink.
