---
id: docker_to_aws_cloudwatch_metrics
...
keywords: ["docker","aws cloudwatch metrics"]
---

In this guide we'll be consuming `docker` logs and writing them to a `aws_cloudwatch_metrics` sink.
