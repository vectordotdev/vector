---
id: journald_to_datadog_metrics
...
keywords: ["journald","datadog metrics"]
---

In this guide we'll be consuming `journald` logs and writing them to a `datadog_metrics` sink.
