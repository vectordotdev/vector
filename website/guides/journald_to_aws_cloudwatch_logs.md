---
id: journald_to_aws_cloudwatch_logs
...
keywords: ["journald","aws cloudwatch logs"]
---

In this guide we'll be consuming `journald` logs and writing them to a `aws_cloudwatch_logs` sink.
