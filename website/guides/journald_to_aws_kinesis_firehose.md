---
id: journald_to_aws_kinesis_firehose
...
keywords: ["journald","aws kinesis firehose"]
---

In this guide we'll be consuming `journald` logs and writing them to a `aws_kinesis_firehose` sink.
