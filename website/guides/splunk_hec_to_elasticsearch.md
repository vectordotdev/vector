---
id: splunk_hec_to_elasticsearch
...
keywords: ["splunk hec","elasticsearch"]
---

In this guide we'll be consuming `splunk_hec` logs and writing them to a `elasticsearch` sink.
