...
description: "A guide to quickly, and correctly, collect logs from Docker and send them anywhere."
author_github: https://github.com/binarylogic
tags: ["type: tutorial","domain: platforms","platform: docker"]
---
...
> "I just wanna, like, collect my logs from Docker and send them somewhere -- why is all of this so complicated?"
>
> — developers

So you want to collect logs from Docker and send them anywhere? Sounds simple! Sadly, it is not.
