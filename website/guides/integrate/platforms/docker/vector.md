...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: vector"]
...
Fear not! In this guide we'll show you how to send send logs from Docker to another Vector instance
