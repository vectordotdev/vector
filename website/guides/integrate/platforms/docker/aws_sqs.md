...
description: "A simple guide to send logs from Docker to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to AWS SQS Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: aws_sqs"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/platforms/docker/aws_sqs.md.erb
-->
