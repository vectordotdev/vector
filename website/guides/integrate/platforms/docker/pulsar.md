...
description: "A guide to quickly, and correctly, send logs from Docker to Apache Pulsar."
author_github: https://github.com/binarylogic
cover_label: "Docker to Apache Pulsar Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","sink: pulsar"]
---
...
> "I just wanna, like, send my logs from Docker to Apache Pulsar -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to Apache Pulsar? Sounds simple! Sadly, it is not.
