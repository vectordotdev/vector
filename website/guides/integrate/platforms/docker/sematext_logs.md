...
description: "A guide to quickly, and correctly, send logs from Docker to Sematext."
author_github: https://github.com/binarylogic
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","sink: sematext_logs"]
---
...
> "I just wanna, like, send my logs from Docker to Sematext -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to Sematext? Sounds simple! Sadly, it is not.
