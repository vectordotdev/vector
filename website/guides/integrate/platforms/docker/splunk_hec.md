...
description: "A guide to quickly, and correctly, send logs from Docker to a Splunk HEC."
author_github: https://github.com/binarylogic
cover_label: "Docker to Splunk HEC Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","sink: splunk_hec"]
---
...
> "I just wanna, like, send my logs from Docker to a Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to a Splunk HEC? Sounds simple! Sadly, it is not.
