...
description: "A guide to quickly, and correctly, send logs from Docker to AWS S3."
author_github: https://github.com/binarylogic
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","sink: aws_s3"]
---
...
> "I just wanna, like, send my logs from Docker to AWS S3 -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to AWS S3? Sounds simple! Sadly, it is not.
