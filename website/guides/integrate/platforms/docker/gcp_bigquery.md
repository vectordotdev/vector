...
description: "A simple guide to send logs from Docker to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to GCP BigQuery Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/platforms/docker/gcp_bigquery.md.erb
-->
