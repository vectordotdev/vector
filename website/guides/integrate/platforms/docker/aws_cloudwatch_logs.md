...
> "I just wanna, like, send my logs from Docker to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to AWS Cloudwatch? Sounds simple! Sadly, it is not.
