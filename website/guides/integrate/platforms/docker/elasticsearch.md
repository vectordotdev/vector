...
description: "A guide to quickly, and correctly, send logs from Docker to Elasticsearch."
...
> "I just wanna, like, send my logs from Docker to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to Elasticsearch? Sounds simple! Sadly, it is not.
