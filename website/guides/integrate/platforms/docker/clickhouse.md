...
description: "A guide to quickly, and correctly, send logs from Docker to Clickhouse."
author_github: https://github.com/binarylogic
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","sink: clickhouse"]
---
...
> "I just wanna, like, send my logs from Docker to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Docker to Clickhouse? Sounds simple! Sadly, it is not.
