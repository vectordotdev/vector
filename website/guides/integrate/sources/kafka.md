...
> "I just wanna, like, collect my logs from Kafka and send them somewhere -- why is all of this so complicated?"
>
> — developers

So you want to collect logs from Kafka and send them anywhere? Sounds simple! Sadly, it is not.
