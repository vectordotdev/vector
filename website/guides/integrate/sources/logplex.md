...
description: "A simple guide to collect logs from Heroku Logplex and send them anywhere in just a few minutes."
...
Fear not! In this guide we'll show you how to send collect logs from [Heroku Logplex][urls.logplex] and send them anywhere
