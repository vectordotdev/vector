...
description: "A simple guide to send logs from Syslog to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/syslog/aws_sqs.md.erb
-->
