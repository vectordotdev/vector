...
description: "A guide to quickly, and correctly, send logs from Syslog to Honeycomb."
...
> "I just wanna, like, send my logs from Syslog to Honeycomb -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Syslog to Honeycomb? Sounds simple! Sadly, it is not.
