...
description: "A guide to quickly, and correctly, send logs from Syslog to Datadog."
...
> "I just wanna, like, send my logs from Syslog to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Syslog to Datadog? Sounds simple! Sadly, it is not.
