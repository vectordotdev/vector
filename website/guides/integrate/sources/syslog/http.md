...
description: "A guide to quickly, and correctly, send logs from Syslog to HTTP."
...
> "I just wanna, like, send my logs from Syslog to HTTP -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Syslog to HTTP? Sounds simple! Sadly, it is not.
