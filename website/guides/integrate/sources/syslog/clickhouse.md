...
> "I just wanna, like, send my logs from Syslog to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Syslog to Clickhouse? Sounds simple! Sadly, it is not.
