...
description: "A guide to quickly, and correctly, send logs from Syslog to LogDNA."
...
> "I just wanna, like, send my logs from Syslog to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Syslog to LogDNA? Sounds simple! Sadly, it is not.
