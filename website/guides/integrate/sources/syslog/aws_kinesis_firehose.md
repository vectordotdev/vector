...
> "I just wanna, like, send my logs from Syslog to AWS Kinesis Firehose -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Syslog to AWS Kinesis Firehose? Sounds simple! Sadly, it is not.
