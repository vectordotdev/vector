...
description: "A guide to quickly, and correctly, send logs from HTTP to Datadog."
...
> "I just wanna, like, send my logs from HTTP to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send logs from HTTP to Datadog? Sounds simple! Sadly, it is not.
