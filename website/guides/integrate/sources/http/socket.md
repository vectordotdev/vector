...
description: "A guide to quickly, and correctly, send logs from HTTP to Socket."
...
> "I just wanna, like, send my logs from HTTP to Socket -- why is all of this so complicated?"
>
> — developers

So you want to send logs from HTTP to Socket? Sounds simple! Sadly, it is not.
