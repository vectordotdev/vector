...
description: "A guide to quickly, and correctly, send logs from HTTP to Papertrail."
...
> "I just wanna, like, send my logs from HTTP to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send logs from HTTP to Papertrail? Sounds simple! Sadly, it is not.
