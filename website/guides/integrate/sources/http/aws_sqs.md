...
description: "A simple guide to send logs from HTTP to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/http/aws_sqs.md.erb
-->
