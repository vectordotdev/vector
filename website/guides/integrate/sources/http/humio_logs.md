...
description: "A guide to quickly, and correctly, send logs from HTTP to Humio."
...
> "I just wanna, like, send my logs from HTTP to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send logs from HTTP to Humio? Sounds simple! Sadly, it is not.
