...
description: "A simple guide to send logs from HTTP to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/http/gcp_bigquery.md.erb
-->
