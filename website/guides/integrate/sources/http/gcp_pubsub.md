...
> "I just wanna, like, send my logs from HTTP to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send logs from HTTP to GCP PubSub? Sounds simple! Sadly, it is not.
