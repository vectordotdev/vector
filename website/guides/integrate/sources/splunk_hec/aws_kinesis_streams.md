...
description: "A guide to quickly, and correctly, send logs from Splunk HEC to AWS Kinesis Data Streams."
...
> "I just wanna, like, send my logs from Splunk HEC to AWS Kinesis Data Streams -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Splunk HEC to AWS Kinesis Data Streams? Sounds simple! Sadly, it is not.
