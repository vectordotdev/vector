...
description: "A guide to quickly, and correctly, send logs from Splunk HEC to Elasticsearch."
...
> "I just wanna, like, send my logs from Splunk HEC to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Splunk HEC to Elasticsearch? Sounds simple! Sadly, it is not.
