...
cover_label: "Splunk HEC to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/gcp_bigquery.md.erb
-->
