...
description: "A guide to quickly, and correctly, send logs from Splunk HEC to Papertrail."
...
> "I just wanna, like, send my logs from Splunk HEC to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Splunk HEC to Papertrail? Sounds simple! Sadly, it is not.
