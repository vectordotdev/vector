...
description: "A simple guide to send logs from Splunk HEC to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to AWS SQS Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: aws_sqs"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/aws_sqs.md.erb
-->
