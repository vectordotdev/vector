...
description: "A guide to quickly, and correctly, send logs from Splunk HEC to Splunk HEC."
...
> "I just wanna, like, send my logs from Splunk HEC to Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Splunk HEC to Splunk HEC? Sounds simple! Sadly, it is not.
