...
> "I just wanna, like, send my logs from Splunk HEC to another Vector instance -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Splunk HEC to another Vector instance? Sounds simple! Sadly, it is not.
