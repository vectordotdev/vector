...
description: "A simple guide to send logs from Kubernetes to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [an HTTP endpoint][urls.http]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/http.md.erb
-->
