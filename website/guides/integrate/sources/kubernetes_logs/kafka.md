...
cover_label: "Kubernetes Logs to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: kafka"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Kafka][urls.kafka]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/kafka.md.erb
-->
