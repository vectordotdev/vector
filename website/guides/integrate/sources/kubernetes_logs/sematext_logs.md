...
cover_label: "Kubernetes Logs to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Sematext][urls.sematext]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/sematext_logs.md.erb
-->
