...
cover_label: "Kubernetes Logs to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: logdna"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [LogDNA][urls.logdna]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/logdna.md.erb
-->
