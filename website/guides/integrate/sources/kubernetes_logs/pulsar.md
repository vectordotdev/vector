...
cover_label: "Kubernetes Logs to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: pulsar"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Apache Pulsar][urls.pulsar]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/pulsar.md.erb
-->
