...
cover_label: "Kubernetes Logs to AWS S3 Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: aws_s3"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [AWS S3][urls.aws_s3]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/aws_s3.md.erb
-->
