...
description: "A simple guide to send logs from Kubernetes to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [a Splunk HEC][urls.splunk_hec]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/splunk_hec.md.erb
-->
