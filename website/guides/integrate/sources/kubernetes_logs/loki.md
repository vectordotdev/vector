...
description: "A simple guide to send logs from Kubernetes to Loki in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Loki][urls.loki]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/loki.md.erb
-->
