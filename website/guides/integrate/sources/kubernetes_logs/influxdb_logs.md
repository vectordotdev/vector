...
description: "A simple guide to send logs from Kubernetes to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [InfluxDB][urls.influxdb]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/influxdb_logs.md.erb
-->
