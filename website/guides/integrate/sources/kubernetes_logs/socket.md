...
description: "A simple guide to send logs from Kubernetes to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/socket.md.erb
-->
