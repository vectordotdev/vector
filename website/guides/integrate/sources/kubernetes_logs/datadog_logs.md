...
description: "A simple guide to send logs from Kubernetes to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: datadog_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/datadog_logs.md.erb
-->
