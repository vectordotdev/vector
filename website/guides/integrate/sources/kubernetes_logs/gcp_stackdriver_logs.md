...
description: "A simple guide to send logs from Kubernetes to GCP Stackdriver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: gcp_stackdriver_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/gcp_stackdriver_logs.md.erb
-->
