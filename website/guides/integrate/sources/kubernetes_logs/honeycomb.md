...
cover_label: "Kubernetes Logs to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Honeycomb][urls.honeycomb]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/honeycomb.md.erb
-->
