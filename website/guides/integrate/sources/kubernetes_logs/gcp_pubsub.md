...
cover_label: "Kubernetes Logs to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/gcp_pubsub.md.erb
-->
