...
description: "A simple guide to send logs from Kubernetes to GCP Cloud Storage (GCS) in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/gcp_cloud_storage.md.erb
-->
