...
cover_label: "Kubernetes Logs to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/clickhouse.md.erb
-->
