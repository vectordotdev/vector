...
cover_label: "Kubernetes Logs to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Papertrail][urls.papertrail]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/papertrail.md.erb
-->
