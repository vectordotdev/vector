...
cover_label: "Kubernetes Logs to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [Humio][urls.humio]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/humio_logs.md.erb
-->
