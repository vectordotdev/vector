...
description: "A simple guide to send logs from Kubernetes to a file in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to File Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: file"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [a file][urls.file]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/file.md.erb
-->
