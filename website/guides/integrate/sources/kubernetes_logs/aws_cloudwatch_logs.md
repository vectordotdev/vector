...
description: "A simple guide to send logs from Kubernetes to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/aws_cloudwatch_logs.md.erb
-->
