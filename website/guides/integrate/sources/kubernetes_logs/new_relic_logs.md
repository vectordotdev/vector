...
description: "A simple guide to send logs from Kubernetes to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kubernetes_logs","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kubernetes][urls.kubernetes] to [New Relic][urls.new_relic]
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs/new_relic_logs.md.erb
-->
