...
description: "A guide to quickly, and correctly, send metrics from Prometheus to AWS Cloudwatch."
...
> "I just wanna, like, send my metrics from Prometheus to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send metrics from Prometheus to AWS Cloudwatch? Sounds simple! Sadly, it is not.
