...
> "I just wanna, like, send my metrics from Prometheus to InfluxDB -- why is all of this so complicated?"
>
> — developers

So you want to send metrics from Prometheus to InfluxDB? Sounds simple! Sadly, it is not.
