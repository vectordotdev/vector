...
description: "A guide to quickly, and correctly, send metrics from Prometheus to Prometheus."
...
> "I just wanna, like, send my metrics from Prometheus to Prometheus -- why is all of this so complicated?"
>
> — developers

So you want to send metrics from Prometheus to Prometheus? Sounds simple! Sadly, it is not.
