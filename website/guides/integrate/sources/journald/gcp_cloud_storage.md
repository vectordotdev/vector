...
> "I just wanna, like, send my logs from Journald to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
