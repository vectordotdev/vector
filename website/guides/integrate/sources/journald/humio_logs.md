...
description: "A guide to quickly, and correctly, send logs from Journald to Humio."
...
> "I just wanna, like, send my logs from Journald to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to Humio? Sounds simple! Sadly, it is not.
