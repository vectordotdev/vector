...
description: "A guide to quickly, and correctly, send logs from Journald to AWS Kinesis Firehose."
...
> "I just wanna, like, send my logs from Journald to AWS Kinesis Firehose -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to AWS Kinesis Firehose? Sounds simple! Sadly, it is not.
