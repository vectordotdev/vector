...
description: "A guide to quickly, and correctly, send logs from Journald to Elasticsearch."
...
> "I just wanna, like, send my logs from Journald to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to Elasticsearch? Sounds simple! Sadly, it is not.
