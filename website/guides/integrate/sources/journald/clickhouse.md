...
> "I just wanna, like, send my logs from Journald to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to Clickhouse? Sounds simple! Sadly, it is not.
