...
description: "A guide to quickly, and correctly, send logs from Journald to Splunk HEC."
...
> "I just wanna, like, send my logs from Journald to Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to Splunk HEC? Sounds simple! Sadly, it is not.
