...
description: "A simple guide to send logs from Journald to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/journald/aws_sqs.md.erb
-->
