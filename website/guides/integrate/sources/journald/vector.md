...
description: "A guide to quickly, and correctly, send logs from Journald to Vector."
...
> "I just wanna, like, send my logs from Journald to Vector -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to Vector? Sounds simple! Sadly, it is not.
