...
description: "A guide to quickly, and correctly, send logs from Journald to Sematext."
...
> "I just wanna, like, send my logs from Journald to Sematext -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Journald to Sematext? Sounds simple! Sadly, it is not.
