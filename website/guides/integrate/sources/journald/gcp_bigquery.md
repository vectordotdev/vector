...
description: "A simple guide to send logs from Journald to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/journald/gcp_bigquery.md.erb
-->
