...
description: "A simple guide to collect logs from Generator and send them anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator Integration"
tags: ["type: tutorial","domain: sources","source: generator"]
...
Fear not! In this guide we'll show you how to send collect logs from [Generator][urls.generator] and send them anywhere
...
<!--
     ...
     website/guides/integrate/sources/generator.md.erb
-->
