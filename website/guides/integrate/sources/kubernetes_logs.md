...
description: "A simple guide to collect logs from Kubernetes and send them anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kubernetes Logs Integration"
tags: ["type: tutorial","domain: sources","source: kubernetes_logs"]
...
Fear not! In this guide we'll show you how to send collect logs from [Kubernetes][urls.kubernetes] and send them anywhere
...
<!--
     ...
     website/guides/integrate/sources/kubernetes_logs.md.erb
-->
