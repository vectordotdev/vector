...
description: "A guide to quickly, and correctly, send logs from a file to Honeycomb."
...
> "I just wanna, like, send my logs from a file to Honeycomb -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a file to Honeycomb? Sounds simple! Sadly, it is not.
