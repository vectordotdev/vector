...
description: "A simple guide to send logs from a file to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/file/gcp_bigquery.md.erb
-->
