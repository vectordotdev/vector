...
description: "A guide to quickly, and correctly, send logs from File to Vector."
...
> "I just wanna, like, send my logs from File to Vector -- why is all of this so complicated?"
>
> — developers

So you want to send logs from File to Vector? Sounds simple! Sadly, it is not.
