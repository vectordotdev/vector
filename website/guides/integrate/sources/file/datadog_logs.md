...
> "I just wanna, like, send my logs from a file to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a file to Datadog? Sounds simple! Sadly, it is not.
