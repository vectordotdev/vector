...
> "I just wanna, like, send my logs from a file to Loki -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a file to Loki? Sounds simple! Sadly, it is not.
