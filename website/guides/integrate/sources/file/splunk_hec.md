...
description: "A guide to quickly, and correctly, send logs from a file to a Splunk HEC."
...
> "I just wanna, like, send my logs from a file to a Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a file to a Splunk HEC? Sounds simple! Sadly, it is not.
