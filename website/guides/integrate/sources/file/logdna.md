...
description: "A guide to quickly, and correctly, send logs from File to LogDNA."
...
> "I just wanna, like, send my logs from File to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send logs from File to LogDNA? Sounds simple! Sadly, it is not.
