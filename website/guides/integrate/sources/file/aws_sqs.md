...
description: "A simple guide to send logs from a file to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/file/aws_sqs.md.erb
-->
