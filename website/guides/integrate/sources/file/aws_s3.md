...
description: "A guide to quickly, and correctly, send logs from File to AWS S3."
...
> "I just wanna, like, send my logs from File to AWS S3 -- why is all of this so complicated?"
>
> — developers

So you want to send logs from File to AWS S3? Sounds simple! Sadly, it is not.
