...
description: "A guide to quickly, and correctly, send logs from a file to New Relic."
...
> "I just wanna, like, send my logs from a file to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a file to New Relic? Sounds simple! Sadly, it is not.
