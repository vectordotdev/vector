...
description: "A guide to quickly, and correctly, send logs from STDIN to Clickhouse."
...
> "I just wanna, like, send my logs from STDIN to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send logs from STDIN to Clickhouse? Sounds simple! Sadly, it is not.
