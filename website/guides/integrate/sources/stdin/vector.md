...
> "I just wanna, like, send my logs from STDIN to another Vector instance -- why is all of this so complicated?"
>
> — developers

So you want to send logs from STDIN to another Vector instance? Sounds simple! Sadly, it is not.
