...
description: "A simple guide to send logs from STDIN to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/stdin/aws_sqs.md.erb
-->
