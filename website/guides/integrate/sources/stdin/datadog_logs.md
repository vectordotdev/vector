...
> "I just wanna, like, send my logs from STDIN to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send logs from STDIN to Datadog? Sounds simple! Sadly, it is not.
