...
description: "A guide to quickly, and correctly, send logs from STDIN to GCP PubSub."
...
> "I just wanna, like, send my logs from STDIN to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send logs from STDIN to GCP PubSub? Sounds simple! Sadly, it is not.
