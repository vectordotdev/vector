...
description: "A simple guide to send logs from STDIN to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/stdin/gcp_bigquery.md.erb
-->
