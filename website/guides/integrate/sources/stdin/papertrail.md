...
description: "A guide to quickly, and correctly, send logs from STDIN to Papertrail."
...
> "I just wanna, like, send my logs from STDIN to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send logs from STDIN to Papertrail? Sounds simple! Sadly, it is not.
