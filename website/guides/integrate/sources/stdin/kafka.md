...
description: "A guide to quickly, and correctly, send logs from STDIN to Kafka."
...
> "I just wanna, like, send my logs from STDIN to Kafka -- why is all of this so complicated?"
>
> — developers

So you want to send logs from STDIN to Kafka? Sounds simple! Sadly, it is not.
