...
description: "A guide to quickly, and correctly, send logs from Vector to GCP Cloud Storage (GCS)."
author_github: https://github.com/binarylogic
cover_label: "Vector to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: gcp_cloud_storage"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs from Vector to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
