...
description: "A simple guide to send logs from Vector to GCP Cloud Storage (GCS) in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from Vector to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
