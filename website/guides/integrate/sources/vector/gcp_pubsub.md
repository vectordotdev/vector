...
description: "A guide to quickly, and correctly, send logs from Vector to GCP PubSub."
author_github: https://github.com/binarylogic
cover_label: "Vector to GCP PubSub Integration"
...
> "I just wanna, like, send my logs from Vector to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to GCP PubSub? Sounds simple! Sadly, it is not.
