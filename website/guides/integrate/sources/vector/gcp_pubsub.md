...
description: "A guide to quickly, and correctly, send logs and metrics from Vector to GCP PubSub."
author_github: https://github.com/binarylogic
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: gcp_pubsub"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs and metrics from Vector to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send logs and metrics from Vector to GCP PubSub? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/vector/gcp_pubsub.md.erb
-->
