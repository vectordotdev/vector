...
description: "A guide to quickly, and correctly, send logs from Vector to AWS Cloudwatch."
author_github: https://github.com/binarylogic
cover_label: "Vector to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: aws_cloudwatch_logs"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs from Vector to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to AWS Cloudwatch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/vector/aws_cloudwatch_logs.md.erb
-->
