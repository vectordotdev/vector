...
description: "A guide to quickly, and correctly, send metrics from Vector to Prometheus."
author_github: https://github.com/binarylogic
cover_label: "Vector to Prometheus Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: prometheus"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my metrics from Vector to Prometheus -- why is all of this so complicated?"
>
> — developers

So you want to send metrics from Vector to Prometheus? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/vector/prometheus.md.erb
-->
