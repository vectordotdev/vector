...
description: "A guide to quickly, and correctly, send logs and metrics from Vector to Prometheus."
...
> "I just wanna, like, send my logs and metrics from Vector to Prometheus -- why is all of this so complicated?"
>
> — developers

So you want to send logs and metrics from Vector to Prometheus? Sounds simple! Sadly, it is not.
