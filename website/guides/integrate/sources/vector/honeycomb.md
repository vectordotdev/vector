...
description: "A guide to quickly, and correctly, send logs from Vector to Honeycomb."
author_github: https://github.com/binarylogic
cover_label: "Vector to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: honeycomb"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs from Vector to Honeycomb -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to Honeycomb? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/vector/honeycomb.md.erb
-->
