...
description: "A guide to quickly, and correctly, send metrics from Vector to AWS Cloudwatch."
author_github: https://github.com/binarylogic
cover_label: "Vector to AWS Cloudwatch Metrics Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: aws_cloudwatch_metrics"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my metrics from Vector to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send metrics from Vector to AWS Cloudwatch? Sounds simple! Sadly, it is not.
