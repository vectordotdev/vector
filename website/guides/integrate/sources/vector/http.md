...
description: "A simple guide to send logs from Vector to an HTTP endpoint in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Vector][urls.vector] to [an HTTP endpoint][urls.http]
