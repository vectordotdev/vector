...
description: "A simple guide to send logs from Vector to AWS S3 in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from Vector to [AWS S3][urls.aws_s3]
