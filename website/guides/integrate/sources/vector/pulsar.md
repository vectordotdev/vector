...
description: "A guide to quickly, and correctly, send logs and metrics from Vector to Apache Pulsar."
...
> "I just wanna, like, send my logs and metrics from Vector to Apache Pulsar -- why is all of this so complicated?"
>
> — developers

So you want to send logs and metrics from Vector to Apache Pulsar? Sounds simple! Sadly, it is not.
