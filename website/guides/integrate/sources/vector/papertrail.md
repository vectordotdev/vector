...
description: "A simple guide to send logs from Vector to Papertrail in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Vector][urls.vector] to [Papertrail][urls.papertrail]
