...
description: "A simple guide to send logs from Vector to Sematext in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Vector][urls.vector] to [Sematext][urls.sematext]
