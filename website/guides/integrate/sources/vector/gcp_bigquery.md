...
description: "A simple guide to send logs from Vector to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Vector to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from Vector to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/vector/gcp_bigquery.md.erb
-->
