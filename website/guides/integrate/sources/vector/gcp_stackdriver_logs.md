...
description: "A guide to quickly, and correctly, send logs from Vector to GCP Stackdriver."
author_github: https://github.com/binarylogic
cover_label: "Vector to GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: gcp_stackdriver_logs"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs from Vector to GCP Stackdriver -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to GCP Stackdriver? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/vector/gcp_stackdriver_logs.md.erb
-->
