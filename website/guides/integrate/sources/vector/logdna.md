...
description: "A guide to quickly, and correctly, send logs from Vector to LogDNA."
author_github: https://github.com/binarylogic
cover_label: "Vector to LogDNA Integration"
...
> "I just wanna, like, send my logs from Vector to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to LogDNA? Sounds simple! Sadly, it is not.
