...
description: "A guide to quickly, and correctly, send logs from Vector to New Relic."
author_github: https://github.com/binarylogic
cover_label: "Vector to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: vector","sink: new_relic_logs"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs from Vector to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Vector to New Relic? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/vector/new_relic_logs.md.erb
-->
