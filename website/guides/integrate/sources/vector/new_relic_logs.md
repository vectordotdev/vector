...
description: "A guide to quickly, and correctly, send logs and metrics from Vector to New Relic."
...
> "I just wanna, like, send my logs and metrics from Vector to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send logs and metrics from Vector to New Relic? Sounds simple! Sadly, it is not.
