...
description: "A simple guide to send logs from Vector to a TCP, UDP, or UDS socket in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Vector][urls.vector] to [a TCP, UDP, or UDS socket][urls.socket]
