...
description: "A simple guide to send logs from Kafka to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/kafka/aws_sqs.md.erb
-->
