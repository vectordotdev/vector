...
description: "A guide to quickly, and correctly, send logs from Kafka to GCP Stackdriver."
...
> "I just wanna, like, send my logs from Kafka to GCP Stackdriver -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Kafka to GCP Stackdriver? Sounds simple! Sadly, it is not.
