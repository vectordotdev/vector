...
description: "A guide to quickly, and correctly, send logs from Kafka to File."
...
> "I just wanna, like, send my logs from Kafka to File -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Kafka to File? Sounds simple! Sadly, it is not.
