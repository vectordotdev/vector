...
description: "A guide to quickly, and correctly, send logs from Kafka to a file."
...
> "I just wanna, like, send my logs from Kafka to a file -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Kafka to a file? Sounds simple! Sadly, it is not.
