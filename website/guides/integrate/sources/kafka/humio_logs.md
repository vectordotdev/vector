...
description: "A guide to quickly, and correctly, send logs from Kafka to Humio."
...
> "I just wanna, like, send my logs from Kafka to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Kafka to Humio? Sounds simple! Sadly, it is not.
