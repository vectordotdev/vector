...
description: "A simple guide to send logs from Kafka to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/kafka/gcp_bigquery.md.erb
-->
