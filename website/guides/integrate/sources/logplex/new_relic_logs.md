...
description: "A simple guide to send logs from Heroku Logplex to New Relic in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [New Relic][urls.new_relic]
