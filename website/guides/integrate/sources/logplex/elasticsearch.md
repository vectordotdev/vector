...
description: "A simple guide to send logs from Heroku Logplex to Elasticsearch in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [Elasticsearch][urls.elasticsearch]
