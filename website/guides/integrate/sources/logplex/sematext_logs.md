...
description: "A simple guide to send logs from Heroku Logplex to Sematext in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [Sematext][urls.sematext]
...
<!--
     ...
     website/guides/integrate/sources/logplex/sematext_logs.md.erb
-->
