...
description: "A simple guide to send logs from Heroku Logplex to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: logplex","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [Papertrail][urls.papertrail]
...
<!--
     ...
     website/guides/integrate/sources/logplex/papertrail.md.erb
-->
