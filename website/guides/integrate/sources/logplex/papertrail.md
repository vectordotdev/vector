...
description: "A guide to quickly, and correctly, send logs from Heroku Logplex to Papertrail."
...
> "I just wanna, like, send my logs from Heroku Logplex to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Heroku Logplex to Papertrail? Sounds simple! Sadly, it is not.
