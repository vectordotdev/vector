...
> "I just wanna, like, send my logs from Heroku Logplex to a Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Heroku Logplex to a Splunk HEC? Sounds simple! Sadly, it is not.
