...
description: "A guide to quickly, and correctly, send logs from Heroku Logplex to LogDNA."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: logplex","sink: logdna"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my logs from Heroku Logplex to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Heroku Logplex to LogDNA? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sources/logplex/logdna.md.erb
-->
