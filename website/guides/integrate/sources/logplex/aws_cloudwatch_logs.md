...
description: "A simple guide to send logs from Heroku Logplex to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: logplex","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sources/logplex/aws_cloudwatch_logs.md.erb
-->
