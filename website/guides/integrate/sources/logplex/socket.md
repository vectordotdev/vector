...
description: "A simple guide to send logs from Heroku Logplex to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Socket Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     website/guides/integrate/sources/logplex/socket.md.erb
-->
