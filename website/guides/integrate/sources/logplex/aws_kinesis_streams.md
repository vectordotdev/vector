...
description: "A simple guide to send logs from Heroku Logplex to AWS Kinesis Data Streams in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [AWS Kinesis Data Streams][urls.aws_kinesis_streams]
...
<!--
     ...
     website/guides/integrate/sources/logplex/aws_kinesis_streams.md.erb
-->
