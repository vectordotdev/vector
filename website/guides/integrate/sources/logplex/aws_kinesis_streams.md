...
> "I just wanna, like, send my logs from Heroku Logplex to AWS Kinesis Data Streams -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Heroku Logplex to AWS Kinesis Data Streams? Sounds simple! Sadly, it is not.
