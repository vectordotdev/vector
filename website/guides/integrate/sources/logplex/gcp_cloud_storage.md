...
> "I just wanna, like, send my logs from Heroku Logplex to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Heroku Logplex to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
