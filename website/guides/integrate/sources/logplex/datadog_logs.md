...
description: "A simple guide to send logs from Heroku Logplex to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: logplex","sink: datadog_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/logplex/datadog_logs.md.erb
-->
