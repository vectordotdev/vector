...
description: "A simple guide to send logs from Heroku Logplex to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Heroku Logplex to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: logplex","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [Heroku Logplex][urls.logplex] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/logplex/gcp_pubsub.md.erb
-->
