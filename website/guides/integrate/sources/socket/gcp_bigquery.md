...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to GCP BigQuery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sources/socket/gcp_bigquery.md.erb
-->
