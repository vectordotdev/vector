...
> "I just wanna, like, send my logs from a TCP, UDP, or UDS socket to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a TCP, UDP, or UDS socket to New Relic? Sounds simple! Sadly, it is not.
