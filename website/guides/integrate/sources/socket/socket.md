...
description: "A guide to quickly, and correctly, send logs from a TCP, UDP, or UDS socket to a TCP, UDP, or UDS socket."
...
> "I just wanna, like, send my logs from a TCP, UDP, or UDS socket to a TCP, UDP, or UDS socket -- why is all of this so complicated?"
>
> — developers

So you want to send logs from a TCP, UDP, or UDS socket to a TCP, UDP, or UDS socket? Sounds simple! Sadly, it is not.
