...
description: "A guide to quickly, and correctly, send logs from Socket to Sematext."
...
> "I just wanna, like, send my logs from Socket to Sematext -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Socket to Sematext? Sounds simple! Sadly, it is not.
