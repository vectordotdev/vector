...
description: "A guide to quickly, and correctly, send logs from Socket to Clickhouse."
...
> "I just wanna, like, send my logs from Socket to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Socket to Clickhouse? Sounds simple! Sadly, it is not.
