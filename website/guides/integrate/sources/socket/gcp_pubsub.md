...
description: "A guide to quickly, and correctly, send logs from Socket to GCP PubSub."
...
> "I just wanna, like, send my logs from Socket to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send logs from Socket to GCP PubSub? Sounds simple! Sadly, it is not.
