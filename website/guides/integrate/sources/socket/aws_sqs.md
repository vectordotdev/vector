...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to AWS SQS Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: aws_sqs"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sources/socket/aws_sqs.md.erb
-->
...
[Amazon SQS][urls.aws_sqs] is a pay-per-use web service for storing messages in transit between computers. Developers use SQS to build distributed applications with decoupled components without having to deal with the overhead of creating and maintaining message queues.
...
[urls.aws_sqs]: https://aws.amazon.com/sqs/
