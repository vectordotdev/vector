...
description: "A simple guide to send logs from Generator to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/generator/gcp_pubsub.md.erb
-->
