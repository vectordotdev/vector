...
description: "A simple guide to send logs from Generator to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [Sematext][urls.sematext]
...
<!--
     ...
     website/guides/integrate/sources/generator/sematext_logs.md.erb
-->
