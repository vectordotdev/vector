...
description: "A simple guide to send logs from Generator to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [an HTTP endpoint][urls.http]
...
<!--
     ...
     website/guides/integrate/sources/generator/http.md.erb
-->
