...
description: "A simple guide to send logs from Generator to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [Elasticsearch][urls.elasticsearch]
...
<!--
     ...
     website/guides/integrate/sources/generator/elasticsearch.md.erb
-->
