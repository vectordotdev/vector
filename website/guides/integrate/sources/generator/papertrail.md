...
description: "A simple guide to send logs from Generator to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [Papertrail][urls.papertrail]
...
<!--
     ...
     website/guides/integrate/sources/generator/papertrail.md.erb
-->
