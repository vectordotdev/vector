...
description: "A simple guide to send logs from Generator to GCP Stackdriver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: gcp_stackdriver_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
     ...
     website/guides/integrate/sources/generator/gcp_stackdriver_logs.md.erb
-->
