...
description: "A simple guide to send logs from Generator to Clickhouse in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/generator/clickhouse.md.erb
-->
