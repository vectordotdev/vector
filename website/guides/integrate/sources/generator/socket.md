...
description: "A simple guide to send logs from Generator to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     website/guides/integrate/sources/generator/socket.md.erb
-->
