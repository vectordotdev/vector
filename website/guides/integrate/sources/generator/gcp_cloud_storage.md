...
description: "A simple guide to send logs from Generator to GCP Cloud Storage (GCS) in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
     ...
     website/guides/integrate/sources/generator/gcp_cloud_storage.md.erb
-->
...
For this guide, Vector will test data from
Generator via Vector's
[`generator`][docs.sources.generator].
