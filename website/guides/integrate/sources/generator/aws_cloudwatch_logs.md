...
description: "A simple guide to send logs from Generator to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sources/generator/aws_cloudwatch_logs.md.erb
-->
