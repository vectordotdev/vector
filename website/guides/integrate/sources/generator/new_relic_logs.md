...
description: "A simple guide to send logs from Generator to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [New Relic][urls.new_relic]
...
<!--
     ...
     website/guides/integrate/sources/generator/new_relic_logs.md.erb
-->
