...
description: "A simple guide to send logs from Generator to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Generator to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: generator","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [Generator][urls.generator] to [a Splunk HEC][urls.splunk_hec]
...
<!--
     ...
     website/guides/integrate/sources/generator/splunk_hec.md.erb
-->
