...
description: "A guide to quickly, and correctly, send logs to Papertrail."
...
> "I just wanna, like, send my logs to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Papertrail? Sounds simple! Sadly, it is not.
