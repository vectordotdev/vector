...
description: "A guide to quickly, and correctly, send logs to Clickhouse."
...
> "I just wanna, like, send my logs to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Clickhouse? Sounds simple! Sadly, it is not.
