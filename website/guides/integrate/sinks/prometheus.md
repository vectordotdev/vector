...
description: "A guide to quickly, and correctly, send metrics to Prometheus."
...
> "I just wanna, like, send my metrics to Prometheus -- why is all of this so complicated?"
>
> — developers

So you want to send metrics to Prometheus? Sounds simple! Sadly, it is not.
