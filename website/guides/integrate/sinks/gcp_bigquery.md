...
description: "A simple guide to send logs to GCP BigQuery in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "GCP BigQuery Integration"
tags: ["type: tutorial","domain: sinks","sink: gcp_bigquery"]
...
Fear not! In this guide we'll show you how to send send logs to [GCP BigQuery][urls.gcp_bigquery]
...
<!--
     ...
     website/guides/integrate/sinks/gcp_bigquery.md.erb
-->
