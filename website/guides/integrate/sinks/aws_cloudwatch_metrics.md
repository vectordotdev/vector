...
description: "A guide to quickly, and correctly, send metrics to AWS Cloudwatch."
...
> "I just wanna, like, send my metrics to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send metrics to AWS Cloudwatch? Sounds simple! Sadly, it is not.
