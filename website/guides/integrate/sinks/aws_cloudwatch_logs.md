...
description: "A guide to quickly, and correctly, send logs to AWS Cloudwatch."
...
> "I just wanna, like, send my logs to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send logs to AWS Cloudwatch? Sounds simple! Sadly, it is not.
