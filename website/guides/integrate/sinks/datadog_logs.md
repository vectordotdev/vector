...
description: "A guide to quickly, and correctly, send logs to Datadog."
...
> "I just wanna, like, send my logs to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Datadog? Sounds simple! Sadly, it is not.
