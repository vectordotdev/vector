...
description: "A guide to quickly, and correctly, send logs to Kafka."
...
> "I just wanna, like, send my logs to Kafka -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Kafka? Sounds simple! Sadly, it is not.
