...
description: "A guide to quickly, and correctly, send logs to Loki."
...
> "I just wanna, like, send my logs to Loki -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Loki? Sounds simple! Sadly, it is not.
