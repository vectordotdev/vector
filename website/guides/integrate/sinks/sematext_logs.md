...
description: "A guide to quickly, and correctly, send logs to Sematext."
...
> "I just wanna, like, send my logs to Sematext -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Sematext? Sounds simple! Sadly, it is not.
