...
description: "A guide to quickly, and correctly, send logs to Humio."
...
> "I just wanna, like, send my logs to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Humio? Sounds simple! Sadly, it is not.
