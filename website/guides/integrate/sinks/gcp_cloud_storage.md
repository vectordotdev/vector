...
description: "A guide to quickly, and correctly, send logs to GCP Cloud Storage (GCS)."
...
> "I just wanna, like, send my logs to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send logs to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
