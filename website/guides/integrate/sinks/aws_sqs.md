...
description: "A simple guide to send logs to AWS SQS in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS SQS Integration"
...
Fear not! In this guide we'll show you how to send send logs to [AWS SQS][urls.aws_sqs]
...
<!--
     ...
     website/guides/integrate/sinks/aws_sqs.md.erb
-->
