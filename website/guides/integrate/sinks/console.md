...
Logs and metrics are an _essential_ part of observing any
...
the basic task of collecting your logs and metrics, but you must do it
...
Fear not! In this guide we'll show you how to send send logs and metrics to [the console][urls.console]
