...
description: "A guide to quickly, and correctly, send logs and metrics to the console."
author_github: https://github.com/binarylogic
cover_label: "Console Integration"
tags: ["type: tutorial","domain: sinks","sink: console"]
---
...
> "I just wanna, like, send my logs and metrics to the console -- why is all of this so complicated?"
>
> — developers

So you want to send logs and metrics to the console? Sounds simple! Sadly, it is not.
