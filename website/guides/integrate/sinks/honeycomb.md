...
description: "A guide to quickly, and correctly, send logs to Honeycomb."
...
> "I just wanna, like, send my logs to Honeycomb -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Honeycomb? Sounds simple! Sadly, it is not.
