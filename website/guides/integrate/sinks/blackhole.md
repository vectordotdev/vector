...
description: "A guide to quickly, and correctly, send logs and metrics to blackhole."
author_github: https://github.com/binarylogic
cover_label: "Blackhole Integration"
tags: ["type: tutorial","domain: sinks","sink: blackhole"]
---
...
> "I just wanna, like, send my logs and metrics to blackhole -- why is all of this so complicated?"
>
> — developers

So you want to send logs and metrics to blackhole? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/integrate/sinks/blackhole.md.erb
-->
...
<ol className="list--checks list--lg list--semi-bold list--primary list--flush">
  ...
  <li>
    Test log throughput.
    <ol>
      <li>Print log totals on an interval.</li>
    </ol>
  </li>
