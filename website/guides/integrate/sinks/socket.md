...
description: "A guide to quickly, and correctly, send logs to a TCP, UDP, or UDS socket."
...
> "I just wanna, like, send my logs to a TCP, UDP, or UDS socket -- why is all of this so complicated?"
>
> — developers

So you want to send logs to a TCP, UDP, or UDS socket? Sounds simple! Sadly, it is not.
