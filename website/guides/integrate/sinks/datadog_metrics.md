...
description: "A guide to quickly, and correctly, send metrics to Datadog."
...
> "I just wanna, like, send my metrics to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send metrics to Datadog? Sounds simple! Sadly, it is not.
