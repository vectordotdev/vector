...
description: "A guide to quickly, and correctly, send logs to a Splunk HEC."
...
> "I just wanna, like, send my logs to a Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send logs to a Splunk HEC? Sounds simple! Sadly, it is not.
