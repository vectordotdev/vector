...
description: "A guide to quickly, and correctly, send logs to Elasticsearch."
...
> "I just wanna, like, send my logs to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send logs to Elasticsearch? Sounds simple! Sadly, it is not.
