---
id: file_to_aws_kinesis_streams
...
keywords: ["file","aws kinesis data streams"]
---

In this guide we'll be consuming `file` logs and writing them to a `aws_kinesis_streams` sink.
