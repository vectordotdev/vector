---
id: kafka_to_aws_cloudwatch_metrics
...
keywords: ["kafka","aws cloudwatch metrics"]
---

In this guide we'll be consuming `kafka` logs and writing them to a `aws_cloudwatch_metrics` sink.
