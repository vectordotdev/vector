---
id: splunk_hec_to_new_relic_logs
...
keywords: ["splunk hec","new relic logs"]
---

In this guide we'll be consuming `splunk_hec` logs and writing them to a `new_relic_logs` sink.
