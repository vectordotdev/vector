...
What good is a Vector pipeline if you can't deploy it? This guide will walk
you through deploying Vector. Because deploying is largely depending on your
environment this will be an interactive guide:
...
For the purposes of this guide we'll keep things simple and deploy Vector
as a daemon.
<Tabs
  block={true}
  defaultValue="daemon"
...
<Tabs
  ...
  className="rounded"
  defaultValue="dpkg"
  values={[{"label":"DPKG","value":"dpkg"},{"label":"Docker CLI","value":"docker-cli"},{"label":"Docker Compose","value":"docker-compose"},{"label":"Homebrew","value":"homebrew"},{"label":"MSI","value":"msi"},{"label":"Nix","value":"nix"},{"label":"RPM","value":"rpm"},{"label":"Vector CLI","value":"vector-cli"}]}>
<TabItem value="dpkg">
