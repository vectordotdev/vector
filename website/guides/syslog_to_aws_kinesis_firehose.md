---
id: syslog_to_aws_kinesis_firehose
...
keywords: ["syslog","aws kinesis firehose"]
---

In this guide we'll be consuming `syslog` logs and writing them to a `aws_kinesis_firehose` sink.
