---
id: kafka_to_aws_kinesis_streams
...
keywords: ["kafka","aws kinesis data streams"]
---

In this guide we'll be consuming `kafka` logs and writing them to a `aws_kinesis_streams` sink.
