---
id: docker_to_aws_kinesis_streams
...
keywords: ["docker","aws kinesis data streams"]
---

In this guide we'll be consuming `docker` logs and writing them to a `aws_kinesis_streams` sink.
