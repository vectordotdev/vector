---
id: file_to_aws_cloudwatch_logs
...
keywords: ["file","aws cloudwatch logs"]
---

In this guide we'll be consuming `file` logs and writing them to a `aws_cloudwatch_logs` sink.
