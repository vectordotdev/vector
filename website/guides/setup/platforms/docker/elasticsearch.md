---
id: "setup/platforms/docker/elasticsearch"
title: "Send Docker logs to Elasticsearch"
description: "A guide to quickly, and correctly, send Docker logs to Elasticsearch."
platform_name: "docker"
sink_name: "elasticsearch"
source_name: "docker"
tags: ["category: setup","source: docker","sink: elasticsearch"]
---
...
> "I just wanna, like, send my Docker logs to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Elasticsearch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/elasticsearch.md.erb
-->
...
To send Docker logs to Elasticsearch _properly_, and accomplish all of the items above,
