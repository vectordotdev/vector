---
id: "setup/platforms/docker/logdna"
...
sink_name: "logdna"
source_name: "docker"
tags: ["category: setup","source: docker","sink: logdna"]
---
...
> "I just wanna, like, send my Docker logs to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to LogDNA? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/logdna.md.erb
-->
...
To send Docker logs to LogDNA _properly_, and accomplish all of the items above,
