...
> "I just wanna, like, send my Docker logs to HTTP -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to HTTP? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/http.md.erb
-->
...
To send Docker logs to HTTP _properly_, and accomplish all of the items above,
