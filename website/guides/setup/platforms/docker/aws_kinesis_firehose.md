---
id: "setup/platforms/docker/aws_kinesis_firehose"
title: "Send Docker logs to AWS Kinesis Firehose"
description: "A guide to quickly, and correctly, send Docker logs to AWS Kinesis Firehose."
platform_name: "docker"
sink_name: "aws_kinesis_firehose"
source_name: "docker"
tags: ["category: setup","source: docker","sink: aws_kinesis_firehose"]
---
...
> "I just wanna, like, send my Docker logs to AWS Kinesis Firehose -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to AWS Kinesis Firehose? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/aws_kinesis_firehose.md.erb
-->
...
To send Docker logs to AWS Kinesis Firehose _properly_, and accomplish all of the items above,
