---
id: "setup/platforms/docker/gcp_stackdriver_logging"
title: "Send Docker logs to GCP Stackdriver Logging"
description: "A guide to quickly, and correctly, send Docker logs to GCP Stackdriver Logging."
platform_name: "docker"
sink_name: "gcp_stackdriver_logging"
source_name: "docker"
tags: ["category: setup","source: docker","sink: gcp_stackdriver_logging"]
---
...
> "I just wanna, like, send my Docker logs to GCP Stackdriver Logging -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to GCP Stackdriver Logging? Sounds simple! Sadly, it is not.
...
To send Docker logs to GCP Stackdriver Logging _properly_, and accomplish all of the items above,
