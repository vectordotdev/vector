---
id: "setup/platforms/docker/new_relic_logs"
title: "Send Docker logs to New Relic"
description: "A guide to quickly, and correctly, send Docker logs to New Relic."
platform_name: "docker"
sink_name: "new_relic_logs"
source_name: "docker"
tags: ["category: setup","source: docker","sink: new_relic_logs"]
---
...
> "I just wanna, like, send my Docker logs to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to New Relic? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/new_relic_logs.md.erb
-->
...
To send Docker logs to New Relic _properly_, and accomplish all of the items above,
