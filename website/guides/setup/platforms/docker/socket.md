---
id: "setup/platforms/docker/socket"
...
sink_name: "socket"
source_name: "docker"
tags: ["category: setup","source: docker","sink: socket"]
---
...
> "I just wanna, like, send my Docker logs to Socket -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Socket? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/socket.md.erb
-->
...
To send Docker logs to Socket _properly_, and accomplish all of the items above,
