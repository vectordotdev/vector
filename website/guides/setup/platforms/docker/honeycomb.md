---
id: "setup/platforms/docker/honeycomb"
title: "Send Docker logs to Honeycomb"
description: "A guide to quickly, and correctly, send Docker logs to Honeycomb."
platform_name: "docker"
sink_name: "honeycomb"
source_name: "docker"
tags: ["category: setup","source: docker","sink: honeycomb"]
---
...
> "I just wanna, like, send my Docker logs to Honeycomb -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Honeycomb? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/honeycomb.md.erb
-->
...
To send Docker logs to Honeycomb _properly_, and accomplish all of the items above,
