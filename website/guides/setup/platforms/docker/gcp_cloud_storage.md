---
id: "setup/platforms/docker/gcp_cloud_storage"
title: "Send Docker logs to GCP Cloud Storage (GCS)"
description: "A guide to quickly, and correctly, send Docker logs to GCP Cloud Storage (GCS)."
platform_name: "docker"
sink_name: "gcp_cloud_storage"
source_name: "docker"
tags: ["category: setup","source: docker","sink: gcp_cloud_storage"]
---
...
> "I just wanna, like, send my Docker logs to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/gcp_cloud_storage.md.erb
-->
...
To send Docker logs to GCP Cloud Storage (GCS) _properly_, and accomplish all of the items above,
