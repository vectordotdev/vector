---
id: "setup/platforms/docker/splunk_hec"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: splunk_hec"]
---
...
> "I just wanna, like, send my Docker logs to Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Splunk HEC? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/splunk_hec.md.erb
-->
...
To send Docker logs to Splunk HEC _properly_, and accomplish all of the items above,
