---
id: "setup/platforms/docker/influxdb_metrics"
title: "Send Docker logs to InfluxDB"
description: "A guide to quickly, and correctly, send Docker logs to InfluxDB."
platform_name: "docker"
sink_name: "influxdb_metrics"
source_name: "docker"
tags: ["category: setup","source: docker","sink: influxdb_metrics"]
---
...
> "I just wanna, like, send my Docker logs to InfluxDB -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to InfluxDB? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/influxdb_metrics.md.erb
-->
...
To send Docker logs to InfluxDB _properly_, and accomplish all of the items above,
