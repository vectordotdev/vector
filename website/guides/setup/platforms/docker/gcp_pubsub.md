---
id: "setup/platforms/docker/gcp_pubsub"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: gcp_pubsub"]
---
...
> "I just wanna, like, send my Docker logs to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to GCP PubSub? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/gcp_pubsub.md.erb
-->
...
To send Docker logs to GCP PubSub _properly_, and accomplish all of the items above,
