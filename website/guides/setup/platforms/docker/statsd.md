---
id: "setup/platforms/docker/statsd"
title: "Send Docker logs to Statsd"
description: "A guide to quickly, and correctly, send Docker logs to Statsd."
platform_name: "docker"
sink_name: "statsd"
source_name: "docker"
tags: ["category: setup","source: docker","sink: statsd"]
---
...
> "I just wanna, like, send my Docker logs to Statsd -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Statsd? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/statsd.md.erb
-->
...
To send Docker logs to Statsd _properly_, and accomplish all of the items above,
