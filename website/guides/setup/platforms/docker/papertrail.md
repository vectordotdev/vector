---
id: "setup/platforms/docker/papertrail"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: papertrail"]
---
...
> "I just wanna, like, send my Docker logs to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Papertrail? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/papertrail.md.erb
-->
...
To send Docker logs to Papertrail _properly_, and accomplish all of the items above,
