---
id: "setup/platforms/docker/aws_cloudwatch_metrics"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: aws_cloudwatch_metrics"]
---
...
> "I just wanna, like, send my Docker logs to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to AWS Cloudwatch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/aws_cloudwatch_metrics.md.erb
-->
...
To send Docker logs to AWS Cloudwatch _properly_, and accomplish all of the items above,
