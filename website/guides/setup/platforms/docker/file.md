...
tags: ["domain: config","source: docker","sink: file"]
---
...
> "I just wanna, like, send my Docker logs to File -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to File? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/file.md.erb
-->
