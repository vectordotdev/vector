---
id: "setup/platforms/docker/kafka"
title: "Send Docker logs to Kafka"
description: "A guide to quickly, and correctly, send Docker logs to Kafka."
platform_name: "docker"
sink_name: "kafka"
source_name: "docker"
tags: ["category: setup","source: docker","sink: kafka"]
---
...
> "I just wanna, like, send my Docker logs to Kafka -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Kafka? Sounds simple! Sadly, it is not.
...
To send Docker logs to Kafka _properly_, and accomplish all of the items above,
