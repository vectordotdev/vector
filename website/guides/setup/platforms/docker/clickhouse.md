---
id: "setup/platforms/docker/clickhouse"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: clickhouse"]
---
...
> "I just wanna, like, send my Docker logs to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Clickhouse? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/clickhouse.md.erb
-->
...
To send Docker logs to Clickhouse _properly_, and accomplish all of the items above,
