---
id: "setup/platforms/docker/datadog_logs"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: datadog_logs"]
---
...
> "I just wanna, like, send my Docker logs to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Datadog? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/datadog_logs.md.erb
-->
...
To send Docker logs to Datadog _properly_, and accomplish all of the items above,
