---
id: "setup/platforms/docker/vector"
title: "Send Docker logs to Vector"
description: "A guide to quickly, and correctly, send Docker logs to Vector."
platform_name: "docker"
sink_name: "vector"
source_name: "docker"
tags: ["category: setup","source: docker","sink: vector"]
---
...
> "I just wanna, like, send my Docker logs to Vector -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Vector? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/vector.md.erb
-->
...
To send Docker logs to Vector _properly_, and accomplish all of the items above,
