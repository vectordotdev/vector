---
id: "setup/platforms/docker/aws_s3"
...
sink_name: "aws_s3"
source_name: "docker"
tags: ["category: setup","source: docker","sink: aws_s3"]
---
...
To send Docker logs to AWS S3 _properly_, and accomplish all of the items above,
