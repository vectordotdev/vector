---
id: "setup/platforms/docker/humio_logs"
...
source_name: "docker"
tags: ["category: setup","source: docker","sink: humio_logs"]
---
...
> "I just wanna, like, send my Docker logs to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Humio? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/humio_logs.md.erb
-->
...
To send Docker logs to Humio _properly_, and accomplish all of the items above,
