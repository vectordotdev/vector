---
id: "setup/platforms/docker/loki"
title: "Send Docker logs to Loki"
description: "A guide to quickly, and correctly, send Docker logs to Loki."
platform_name: "docker"
sink_name: "loki"
source_name: "docker"
tags: ["category: setup","source: docker","sink: loki"]
---
...
> "I just wanna, like, send my Docker logs to Loki -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Loki? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/loki.md.erb
-->
...
To send Docker logs to Loki _properly_, and accomplish all of the items above,
