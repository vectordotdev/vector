---
id: "setup/platforms/docker/prometheus"
title: "Send Docker logs to Prometheus"
description: "A guide to quickly, and correctly, send Docker logs to Prometheus."
platform_name: "docker"
sink_name: "prometheus"
source_name: "docker"
tags: ["category: setup","source: docker","sink: prometheus"]
---
...
> "I just wanna, like, send my Docker logs to Prometheus -- why is all of this so complicated?"
>
> — developers

So you want to send Docker logs to Prometheus? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/platforms/docker/prometheus.md.erb
-->
...
To send Docker logs to Prometheus _properly_, and accomplish all of the items above,
