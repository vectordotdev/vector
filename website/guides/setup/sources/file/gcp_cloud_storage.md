---
id: "setup/sources/file/gcp_cloud_storage"
...
source_name: "file"
tags: ["category: setup","source: file","sink: gcp_cloud_storage"]
---
...
> "I just wanna, like, send my File logs to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/gcp_cloud_storage.md.erb
-->
...
To send File logs to GCP Cloud Storage (GCS) _properly_, and accomplish all of the items above,
