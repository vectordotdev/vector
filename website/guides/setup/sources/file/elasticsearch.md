---
id: "setup/sources/file/elasticsearch"
...
source_name: "file"
tags: ["category: setup","source: file","sink: elasticsearch"]
---
...
> "I just wanna, like, send my File logs to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Elasticsearch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/elasticsearch.md.erb
-->
...
To send File logs to Elasticsearch _properly_, and accomplish all of the items above,
