---
id: "setup/sources/file/aws_kinesis_streams"
title: "Send File logs to AWS Kinesis Data Streams"
description: "A guide to quickly, and correctly, send File logs to AWS Kinesis Data Streams."
platform_name: 
sink_name: "aws_kinesis_streams"
source_name: "file"
tags: ["category: setup","source: file","sink: aws_kinesis_streams"]
---
...
> "I just wanna, like, send my File logs to AWS Kinesis Data Streams -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to AWS Kinesis Data Streams? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/aws_kinesis_streams.md.erb
-->
...
To send File logs to AWS Kinesis Data Streams _properly_, and accomplish all of the items above,
