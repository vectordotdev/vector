...
> "I just wanna, like, send my File logs to AWS S3 -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to AWS S3? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/aws_s3.md.erb
-->
...
To send File logs to AWS S3 _properly_, and accomplish all of the items above,
