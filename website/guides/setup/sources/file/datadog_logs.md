---
id: "setup/sources/file/datadog_logs"
title: "Send File logs to Datadog"
description: "A guide to quickly, and correctly, send File logs to Datadog."
platform_name: 
sink_name: "datadog_logs"
source_name: "file"
tags: ["category: setup","source: file","sink: datadog_logs"]
---
...
> "I just wanna, like, send my File logs to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Datadog? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/datadog_logs.md.erb
-->
...
To send File logs to Datadog _properly_, and accomplish all of the items above,
