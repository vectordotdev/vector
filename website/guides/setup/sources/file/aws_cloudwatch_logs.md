---
id: "setup/sources/file/aws_cloudwatch_logs"
...
source_name: "file"
tags: ["category: setup","source: file","sink: aws_cloudwatch_logs"]
---
...
> "I just wanna, like, send my File logs to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to AWS Cloudwatch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/aws_cloudwatch_logs.md.erb
-->
...
To send File logs to AWS Cloudwatch _properly_, and accomplish all of the items above,
