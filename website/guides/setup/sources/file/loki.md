---
id: "setup/sources/file/loki"
title: "Send File logs to Loki"
description: "A guide to quickly, and correctly, send File logs to Loki."
platform_name: 
sink_name: "loki"
source_name: "file"
tags: ["category: setup","source: file","sink: loki"]
---
...
> "I just wanna, like, send my File logs to Loki -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Loki? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/loki.md.erb
-->
...
To send File logs to Loki _properly_, and accomplish all of the items above,
