---
id: "setup/sources/file/gcp_stackdriver_logging"
...
source_name: "file"
tags: ["category: setup","source: file","sink: gcp_stackdriver_logging"]
---
...
<!--
     ...
     website/guides/setup/sources/file/gcp_stackdriver_logging.md.erb
-->
...
To send File logs to GCP Stackdriver Logging _properly_, and accomplish all of the items above,
