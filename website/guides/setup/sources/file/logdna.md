---
id: "setup/sources/file/logdna"
title: "Send File logs to LogDNA"
description: "A guide to quickly, and correctly, send File logs to LogDNA."
platform_name: 
sink_name: "logdna"
source_name: "file"
tags: ["category: setup","source: file","sink: logdna"]
---
...
> "I just wanna, like, send my File logs to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to LogDNA? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/logdna.md.erb
-->
...
To send File logs to LogDNA _properly_, and accomplish all of the items above,
