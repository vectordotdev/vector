...
> "I just wanna, like, send my File logs to Kafka -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Kafka? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/kafka.md.erb
-->
...
To send File logs to Kafka _properly_, and accomplish all of the items above,
