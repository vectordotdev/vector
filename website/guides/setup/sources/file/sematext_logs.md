---
id: "setup/sources/file/sematext_logs"
...
source_name: "file"
tags: ["category: setup","source: file","sink: sematext_logs"]
---
...
> "I just wanna, like, send my File logs to Sematext -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Sematext? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/sematext_logs.md.erb
-->
...
To send File logs to Sematext _properly_, and accomplish all of the items above,
