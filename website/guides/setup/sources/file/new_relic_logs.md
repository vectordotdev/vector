---
id: "setup/sources/file/new_relic_logs"
title: "Send File logs to New Relic"
description: "A guide to quickly, and correctly, send File logs to New Relic."
platform_name: 
sink_name: "new_relic_logs"
source_name: "file"
tags: ["category: setup","source: file","sink: new_relic_logs"]
---
...
> "I just wanna, like, send my File logs to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to New Relic? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/new_relic_logs.md.erb
-->
...
To send File logs to New Relic _properly_, and accomplish all of the items above,
