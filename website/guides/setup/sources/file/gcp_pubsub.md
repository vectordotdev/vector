---
id: "setup/sources/file/gcp_pubsub"
title: "Send File logs to GCP PubSub"
description: "A guide to quickly, and correctly, send File logs to GCP PubSub."
platform_name: 
sink_name: "gcp_pubsub"
source_name: "file"
tags: ["category: setup","source: file","sink: gcp_pubsub"]
---
...
> "I just wanna, like, send my File logs to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to GCP PubSub? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/gcp_pubsub.md.erb
-->
...
To send File logs to GCP PubSub _properly_, and accomplish all of the items above,
