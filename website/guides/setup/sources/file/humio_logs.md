---
id: "setup/sources/file/humio_logs"
title: "Send File logs to Humio"
description: "A guide to quickly, and correctly, send File logs to Humio."
platform_name: 
sink_name: "humio_logs"
source_name: "file"
tags: ["category: setup","source: file","sink: humio_logs"]
---
...
> "I just wanna, like, send my File logs to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Humio? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/humio_logs.md.erb
-->
...
To send File logs to Humio _properly_, and accomplish all of the items above,
