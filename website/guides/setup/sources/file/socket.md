...
tags: ["domain: config","source: file","sink: socket"]
---
...
> "I just wanna, like, send my File logs to Socket -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Socket? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/socket.md.erb
-->
