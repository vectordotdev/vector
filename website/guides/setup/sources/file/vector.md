...
> "I just wanna, like, send my File logs to Vector -- why is all of this so complicated?"
>
> — developers

So you want to send File logs to Vector? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/file/vector.md.erb
-->
...
To send File logs to Vector _properly_, and accomplish all of the items above,
