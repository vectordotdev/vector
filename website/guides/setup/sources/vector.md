---
id: "setup/sources/vector"
title: "Collect your Vector logs and metrics and send them anywhere"
description: "A guide to quickly, and correctly, collect your Vector logs and metrics and send them anywhere."
tags: ["category: setup","source: vector"]
---
...
> "I just wanna, like, collect my Vector logs and metrics and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your Vector logs and metrics and send them anywhere? Sounds simple! Sadly, it is not.
...
<Tabs
  ...
  values={[{"label":"AWS Cloudwatch Logs","value":"aws_cloudwatch_logs"},{"label":"AWS Cloudwatch Metrics","value":"aws_cloudwatch_metrics"},{"label":"AWS Kinesis Firehose","value":"aws_kinesis_firehose"},{"label":"AWS Kinesis Data Streams","value":"aws_kinesis_streams"},{"label":"AWS S3","value":"aws_s3"},{"label":"Blackhole","value":"blackhole"},{"label":"Clickhouse","value":"clickhouse"},{"label":"Console","value":"console"},{"label":"Datadog Metrics","value":"datadog_metrics"},{"label":"Elasticsearch","value":"elasticsearch"},{"label":"File","value":"file"},{"label":"GCP Cloud Storage (GCS)","value":"gcp_cloud_storage"},{"label":"GCP PubSub","value":"gcp_pubsub"},{"label":"GCP Stackdriver Logging","value":"gcp_stackdriver_logging"},{"label":"Honeycomb","value":"honeycomb"},{"label":"HTTP","value":"http"},{"label":"Humio Logs","value":"humio_logs"},{"label":"InfluxDB Metrics","value":"influxdb_metrics"},{"label":"Kafka","value":"kafka"},{"label":"LogDNA","value":"logdna"},{"label":"loki","value":"loki"},{"label":"New Relic Logs","value":"new_relic_logs"},{"label":"Papertrail","value":"papertrail"},{"label":"Prometheus","value":"prometheus"},{"label":"Apache Pulsar","value":"pulsar"},{"label":"Sematext Logs","value":"sematext_logs"},{"label":"Socket","value":"socket"},{"label":"Splunk HEC","value":"splunk_hec"},{"label":"Statsd","value":"statsd"},{"label":"Vector","value":"vector"}]}>
...
* The the [`vector` source][docs.sources.vector] ingests data through another upstream [`vector` sink][docs.sinks.vector] and outputs [`log`][docs.data-model.log] and [`metric`][docs.data-model.metric] events.
