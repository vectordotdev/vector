---
id: "setup/sources/logplex"
title: "Collect your Heroku Logplex logs and send them anywhere"
description: "A guide to quickly, and correctly, collect your Heroku Logplex logs and send them anywhere."
tags: ["category: setup","source: logplex"]
---
...
> "I just wanna, like, collect my Heroku Logplex logs and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your Heroku Logplex logs and send them anywhere? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/logplex.md.erb
-->
...
* The the [`logplex` source][docs.sources.logplex] ingests data through the [Heroku Logplex HTTP Drain protocol][urls.logplex_protocol] and outputs [`log`][docs.data-model.log] events.
