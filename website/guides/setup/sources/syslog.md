---
id: "setup/sources/syslog"
title: "Collect your Syslog logs and send them anywhere"
description: "A guide to quickly, and correctly, collect your Syslog logs and send them anywhere."
tags: ["category: setup","source: syslog"]
---
...
> "I just wanna, like, collect my Syslog logs and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your Syslog logs and send them anywhere? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/syslog.md.erb
-->
...
* The the [`syslog` source][docs.sources.syslog] ingests data through the Syslog protocol and [outputs `log` events](#output).
