---
id: "setup/sources/prometheus/influxdb_metrics"
...
platform_name: 
sink_name: "influxdb_metrics"
source_name: "prometheus"
tags: ["category: setup","source: prometheus","sink: influxdb_metrics"]
---
...
> "I just wanna, like, send my Prometheus metrics to InfluxDB -- why is all of this so complicated?"
>
> — developers

So you want to send Prometheus metrics to InfluxDB? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/prometheus/influxdb_metrics.md.erb
-->
...
To send Prometheus metrics to InfluxDB _properly_, and accomplish all of the items above,
