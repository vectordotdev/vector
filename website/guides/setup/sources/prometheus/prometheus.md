---
id: "setup/sources/prometheus/prometheus"
...
tags: ["category: setup","source: prometheus","sink: prometheus"]
---
...
To send Prometheus metrics to Prometheus _properly_, and accomplish all of the items above,
