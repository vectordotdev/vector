---
id: "setup/sources/socket"
title: "Collect your Socket logs and send them anywhere"
description: "A guide to quickly, and correctly, collect your Socket logs and send them anywhere."
tags: ["category: setup","source: socket"]
---
...
> "I just wanna, like, collect my Socket logs and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your Socket logs and send them anywhere? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/socket.md.erb
-->
...
* The the [`socket` source][docs.sources.socket] ingests data through a socket, such as a TCP, UDP, or Unix socket and [outputs `log` events](#output).
