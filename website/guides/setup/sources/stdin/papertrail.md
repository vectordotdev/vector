---
id: "setup/sources/stdin/papertrail"
title: "Send STDIN logs to Papertrail"
description: "A guide to quickly, and correctly, send STDIN logs to Papertrail."
platform_name: 
sink_name: "papertrail"
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: papertrail"]
---
...
> "I just wanna, like, send my STDIN logs to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Papertrail? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/papertrail.md.erb
-->
...
To send STDIN logs to Papertrail _properly_, and accomplish all of the items above,
...
* The the [`stdin` source][docs.sources.stdin] ingests data through standard input (STDIN) and [outputs `log` events](#output).
