...
> "I just wanna, like, send my STDIN logs to Loki -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Loki? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/loki.md.erb
-->
...
To send STDIN logs to Loki _properly_, and accomplish all of the items above,
