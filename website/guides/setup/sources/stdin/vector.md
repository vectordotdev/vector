---
id: "setup/sources/stdin/vector"
title: "Send STDIN logs to Vector"
description: "A guide to quickly, and correctly, send STDIN logs to Vector."
platform_name: 
sink_name: "vector"
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: vector"]
---
...
> "I just wanna, like, send my STDIN logs to Vector -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Vector? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/vector.md.erb
-->
...
To send STDIN logs to Vector _properly_, and accomplish all of the items above,
