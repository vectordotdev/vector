---
id: "setup/sources/stdin/clickhouse"
title: "Send STDIN logs to Clickhouse"
description: "A guide to quickly, and correctly, send STDIN logs to Clickhouse."
platform_name: 
sink_name: "clickhouse"
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: clickhouse"]
---
...
> "I just wanna, like, send my STDIN logs to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Clickhouse? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/clickhouse.md.erb
-->
...
To send STDIN logs to Clickhouse _properly_, and accomplish all of the items above,
