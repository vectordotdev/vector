---
id: "setup/sources/stdin/aws_kinesis_streams"
...
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: aws_kinesis_streams"]
---
...
To send STDIN logs to AWS Kinesis Data Streams _properly_, and accomplish all of the items above,
