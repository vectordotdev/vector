---
id: "setup/sources/stdin/aws_cloudwatch_logs"
title: "Send STDIN logs to AWS Cloudwatch"
description: "A guide to quickly, and correctly, send STDIN logs to AWS Cloudwatch."
platform_name: 
sink_name: "aws_cloudwatch_logs"
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: aws_cloudwatch_logs"]
---
...
> "I just wanna, like, send my STDIN logs to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to AWS Cloudwatch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/aws_cloudwatch_logs.md.erb
-->
...
To send STDIN logs to AWS Cloudwatch _properly_, and accomplish all of the items above,
