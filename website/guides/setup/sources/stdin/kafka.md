---
id: "setup/sources/stdin/kafka"
title: "Send STDIN logs to Kafka"
description: "A guide to quickly, and correctly, send STDIN logs to Kafka."
platform_name: 
sink_name: "kafka"
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: kafka"]
---
...
> "I just wanna, like, send my STDIN logs to Kafka -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Kafka? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/kafka.md.erb
-->
...
To send STDIN logs to Kafka _properly_, and accomplish all of the items above,
