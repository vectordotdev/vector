---
id: "setup/sources/stdin/gcp_pubsub"
...
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: gcp_pubsub"]
---
...
To send STDIN logs to GCP PubSub _properly_, and accomplish all of the items above,
