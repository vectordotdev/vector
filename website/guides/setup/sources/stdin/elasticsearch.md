---
id: "setup/sources/stdin/elasticsearch"
...
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: elasticsearch"]
---
...
> "I just wanna, like, send my STDIN logs to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Elasticsearch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/elasticsearch.md.erb
-->
...
To send STDIN logs to Elasticsearch _properly_, and accomplish all of the items above,
