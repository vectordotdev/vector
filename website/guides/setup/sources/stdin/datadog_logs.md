---
id: "setup/sources/stdin/datadog_logs"
title: "Send STDIN logs to Datadog"
description: "A guide to quickly, and correctly, send STDIN logs to Datadog."
platform_name: 
sink_name: "datadog_logs"
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: datadog_logs"]
---
...
> "I just wanna, like, send my STDIN logs to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Datadog? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/datadog_logs.md.erb
-->
...
To send STDIN logs to Datadog _properly_, and accomplish all of the items above,
