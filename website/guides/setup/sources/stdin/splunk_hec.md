---
id: "setup/sources/stdin/splunk_hec"
...
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: splunk_hec"]
---
...
> "I just wanna, like, send my STDIN logs to Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to Splunk HEC? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/splunk_hec.md.erb
-->
...
To send STDIN logs to Splunk HEC _properly_, and accomplish all of the items above,
