---
id: "setup/sources/stdin/gcp_cloud_storage"
...
source_name: "stdin"
tags: ["category: setup","source: stdin","sink: gcp_cloud_storage"]
---
...
> "I just wanna, like, send my STDIN logs to GCP Cloud Storage (GCS) -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to GCP Cloud Storage (GCS)? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/gcp_cloud_storage.md.erb
-->
...
To send STDIN logs to GCP Cloud Storage (GCS) _properly_, and accomplish all of the items above,
