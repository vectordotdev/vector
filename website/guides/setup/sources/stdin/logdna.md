...
> "I just wanna, like, send my STDIN logs to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to LogDNA? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/logdna.md.erb
-->
...
To send STDIN logs to LogDNA _properly_, and accomplish all of the items above,
