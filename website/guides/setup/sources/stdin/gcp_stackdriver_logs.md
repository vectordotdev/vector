...
description: "A guide to quickly, and correctly, send STDIN logs to GCP Stackdriver."
author_github: https://github.com/binarylogic
tags: ["domain: config","source: stdin","sink: gcp_stackdriver_logs"]
---

import ConfigExample from '@site/src/components/ConfigExample';
import InstallationCommand from '@site/src/components/InstallationCommand';

> "I just wanna, like, send my STDIN logs to GCP Stackdriver -- why is all of this so complicated?"
>
> — developers

So you want to send STDIN logs to GCP Stackdriver? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/stdin/gcp_stackdriver_logs.md.erb
-->
