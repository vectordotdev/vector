---
id: "setup/sources/kafka"
title: "Collect your Kafka logs and send them anywhere"
description: "A guide to quickly, and correctly, collect your Kafka logs and send them anywhere."
tags: ["category: setup","source: kafka"]
---
...
> "I just wanna, like, collect my Kafka logs and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your Kafka logs and send them anywhere? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/kafka.md.erb
-->
...
* The the [`kafka` source][docs.sources.kafka] ingests data through Kafka and [outputs `log` events](#output).
