---
id: "setup/sources/http"
title: "Collect your HTTP logs and send them anywhere"
description: "A guide to quickly, and correctly, collect your HTTP logs and send them anywhere."
tags: ["category: setup","source: http"]
---
...
> "I just wanna, like, collect my HTTP logs and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your HTTP logs and send them anywhere? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/http.md.erb
-->
