---
id: "setup/sources/splunk_hec"
title: "Collect your Splunk HEC logs and send them anywhere"
description: "A guide to quickly, and correctly, collect your Splunk HEC logs and send them anywhere."
tags: ["category: setup","source: splunk_hec"]
---
...
> "I just wanna, like, collect my Splunk HEC logs and send them anywhere -- why is all of this so complicated?"
>
> — developers

So you want to collect your Splunk HEC logs and send them anywhere? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/splunk_hec.md.erb
-->
...
* The the [`splunk_hec` source][docs.sources.splunk_hec] ingests data through the [Splunk HTTP Event Collector protocol][urls.splunk_hec_protocol] and [outputs `log` events](#output).
