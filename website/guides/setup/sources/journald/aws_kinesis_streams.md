---
id: "setup/sources/journald/aws_kinesis_streams"
...
tags: ["category: setup","source: journald","sink: aws_kinesis_streams"]
---
...
> "I just wanna, like, send my Journald logs to AWS Kinesis Data Streams -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to AWS Kinesis Data Streams? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/aws_kinesis_streams.md.erb
-->
...
To send Journald logs to AWS Kinesis Data Streams _properly_, and accomplish all of the items above,
