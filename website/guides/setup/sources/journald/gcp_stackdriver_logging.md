---
id: "setup/sources/journald/gcp_stackdriver_logging"
title: "Send Journald logs to GCP Stackdriver Logging"
description: "A guide to quickly, and correctly, send Journald logs to GCP Stackdriver Logging."
platform_name: 
sink_name: "gcp_stackdriver_logging"
source_name: "journald"
tags: ["category: setup","source: journald","sink: gcp_stackdriver_logging"]
---
...
> "I just wanna, like, send my Journald logs to GCP Stackdriver Logging -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to GCP Stackdriver Logging? Sounds simple! Sadly, it is not.
...
To send Journald logs to GCP Stackdriver Logging _properly_, and accomplish all of the items above,
