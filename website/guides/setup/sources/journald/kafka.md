---
id: "setup/sources/journald/kafka"
...
tags: ["category: setup","source: journald","sink: kafka"]
---
...
> "I just wanna, like, send my Journald logs to Kafka -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Kafka? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/kafka.md.erb
-->
...
To send Journald logs to Kafka _properly_, and accomplish all of the items above,
