---
id: "setup/sources/journald/aws_cloudwatch_logs"
...
tags: ["category: setup","source: journald","sink: aws_cloudwatch_logs"]
---
...
> "I just wanna, like, send my Journald logs to AWS Cloudwatch -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to AWS Cloudwatch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/aws_cloudwatch_logs.md.erb
-->
...
To send Journald logs to AWS Cloudwatch _properly_, and accomplish all of the items above,
