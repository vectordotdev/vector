---
id: "setup/sources/journald/aws_kinesis_firehose"
title: "Send Journald logs to AWS Kinesis Firehose"
description: "A guide to quickly, and correctly, send Journald logs to AWS Kinesis Firehose."
platform_name: 
sink_name: "aws_kinesis_firehose"
source_name: "journald"
tags: ["category: setup","source: journald","sink: aws_kinesis_firehose"]
---
...
> "I just wanna, like, send my Journald logs to AWS Kinesis Firehose -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to AWS Kinesis Firehose? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/aws_kinesis_firehose.md.erb
-->
...
To send Journald logs to AWS Kinesis Firehose _properly_, and accomplish all of the items above,
