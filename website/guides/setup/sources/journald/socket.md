---
id: "setup/sources/journald/socket"
title: "Send Journald logs to Socket"
description: "A guide to quickly, and correctly, send Journald logs to Socket."
platform_name: 
sink_name: "socket"
source_name: "journald"
tags: ["category: setup","source: journald","sink: socket"]
---
...
> "I just wanna, like, send my Journald logs to Socket -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Socket? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/socket.md.erb
-->
...
To send Journald logs to Socket _properly_, and accomplish all of the items above,
