---
id: "setup/sources/journald/gcp_pubsub"
...
tags: ["category: setup","source: journald","sink: gcp_pubsub"]
---
...
> "I just wanna, like, send my Journald logs to GCP PubSub -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to GCP PubSub? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/gcp_pubsub.md.erb
-->
...
To send Journald logs to GCP PubSub _properly_, and accomplish all of the items above,
