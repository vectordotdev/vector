---
id: "setup/sources/journald/file"
...
tags: ["category: setup","source: journald","sink: file"]
---
...
> "I just wanna, like, send my Journald logs to File -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to File? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/file.md.erb
-->
...
To send Journald logs to File _properly_, and accomplish all of the items above,
