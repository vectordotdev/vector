---
id: "setup/sources/journald/clickhouse"
...
tags: ["category: setup","source: journald","sink: clickhouse"]
---
...
> "I just wanna, like, send my Journald logs to Clickhouse -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Clickhouse? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/clickhouse.md.erb
-->
...
To send Journald logs to Clickhouse _properly_, and accomplish all of the items above,
