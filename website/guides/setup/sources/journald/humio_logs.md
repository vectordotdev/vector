---
id: "setup/sources/journald/humio_logs"
...
tags: ["category: setup","source: journald","sink: humio_logs"]
---
...
> "I just wanna, like, send my Journald logs to Humio -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Humio? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/humio_logs.md.erb
-->
...
To send Journald logs to Humio _properly_, and accomplish all of the items above,
