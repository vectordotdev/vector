---
id: "setup/sources/journald/logdna"
title: "Send Journald logs to LogDNA"
description: "A guide to quickly, and correctly, send Journald logs to LogDNA."
platform_name: 
sink_name: "logdna"
source_name: "journald"
tags: ["category: setup","source: journald","sink: logdna"]
---
...
> "I just wanna, like, send my Journald logs to LogDNA -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to LogDNA? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/logdna.md.erb
-->
...
To send Journald logs to LogDNA _properly_, and accomplish all of the items above,
