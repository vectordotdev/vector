---
id: "setup/sources/journald/sematext_logs"
...
tags: ["category: setup","source: journald","sink: sematext_logs"]
---
...
> "I just wanna, like, send my Journald logs to Sematext -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Sematext? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/sematext_logs.md.erb
-->
...
To send Journald logs to Sematext _properly_, and accomplish all of the items above,
