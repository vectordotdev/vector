---
id: "setup/sources/journald/elasticsearch"
...
tags: ["category: setup","source: journald","sink: elasticsearch"]
---
...
> "I just wanna, like, send my Journald logs to Elasticsearch -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Elasticsearch? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/elasticsearch.md.erb
-->
...
To send Journald logs to Elasticsearch _properly_, and accomplish all of the items above,
