---
id: "setup/sources/journald/splunk_hec"
...
tags: ["category: setup","source: journald","sink: splunk_hec"]
---
...
> "I just wanna, like, send my Journald logs to Splunk HEC -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Splunk HEC? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/splunk_hec.md.erb
-->
...
To send Journald logs to Splunk HEC _properly_, and accomplish all of the items above,
