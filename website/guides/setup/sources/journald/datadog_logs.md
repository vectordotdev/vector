---
id: "setup/sources/journald/datadog_logs"
title: "Send Journald logs to Datadog"
description: "A guide to quickly, and correctly, send Journald logs to Datadog."
platform_name: 
sink_name: "datadog_logs"
source_name: "journald"
tags: ["category: setup","source: journald","sink: datadog_logs"]
---
...
> "I just wanna, like, send my Journald logs to Datadog -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Datadog? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/datadog_logs.md.erb
-->
...
To send Journald logs to Datadog _properly_, and accomplish all of the items above,
