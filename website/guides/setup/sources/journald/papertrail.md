---
id: "setup/sources/journald/papertrail"
...
tags: ["category: setup","source: journald","sink: papertrail"]
---
...
> "I just wanna, like, send my Journald logs to Papertrail -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Papertrail? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/papertrail.md.erb
-->
...
To send Journald logs to Papertrail _properly_, and accomplish all of the items above,
