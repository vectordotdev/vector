---
id: "setup/sources/journald/aws_s3"
title: "Send Journald logs to AWS S3"
description: "A guide to quickly, and correctly, send Journald logs to AWS S3."
platform_name: 
sink_name: "aws_s3"
source_name: "journald"
tags: ["category: setup","source: journald","sink: aws_s3"]
---
...
> "I just wanna, like, send my Journald logs to AWS S3 -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to AWS S3? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/aws_s3.md.erb
-->
...
To send Journald logs to AWS S3 _properly_, and accomplish all of the items above,
