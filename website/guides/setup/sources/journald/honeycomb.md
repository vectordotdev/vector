---
id: "setup/sources/journald/honeycomb"
...
tags: ["category: setup","source: journald","sink: honeycomb"]
---
...
> "I just wanna, like, send my Journald logs to Honeycomb -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to Honeycomb? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/honeycomb.md.erb
-->
...
To send Journald logs to Honeycomb _properly_, and accomplish all of the items above,
