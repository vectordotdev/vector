---
id: "setup/sources/journald/http"
title: "Send Journald logs to HTTP"
description: "A guide to quickly, and correctly, send Journald logs to HTTP."
platform_name: 
sink_name: "http"
source_name: "journald"
tags: ["category: setup","source: journald","sink: http"]
---
...
> "I just wanna, like, send my Journald logs to HTTP -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to HTTP? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/http.md.erb
-->
...
To send Journald logs to HTTP _properly_, and accomplish all of the items above,
