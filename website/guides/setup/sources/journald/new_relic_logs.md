---
id: "setup/sources/journald/new_relic_logs"
...
tags: ["category: setup","source: journald","sink: new_relic_logs"]
---
...
> "I just wanna, like, send my Journald logs to New Relic -- why is all of this so complicated?"
>
> — developers

So you want to send Journald logs to New Relic? Sounds simple! Sadly, it is not.
...
<!--
     ...
     website/guides/setup/sources/journald/new_relic_logs.md.erb
-->
...
To send Journald logs to New Relic _properly_, and accomplish all of the items above,
