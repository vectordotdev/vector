---
id: splunk_hec_to_aws_cloudwatch_logs
...
keywords: ["splunk hec","aws cloudwatch logs"]
---

In this guide we'll be consuming `splunk_hec` logs and writing them to a `aws_cloudwatch_logs` sink.
