---
id: file_to_aws_cloudwatch_metrics
...
keywords: ["file","aws cloudwatch metrics"]
---

In this guide we'll be consuming `file` logs and writing them to a `aws_cloudwatch_metrics` sink.
...
Next, create a config file and add a `file` source:
