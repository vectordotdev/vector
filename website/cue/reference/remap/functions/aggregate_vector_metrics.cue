  ...
  "remap": {
    "functions": {
      "aggregate_vector_metrics": {
        "anchor": "aggregate_vector_metrics",
        ...
        "examples": [
          {
            ...
            "source": "aggregate_vector_metrics(\"sum\", \"utilization\")",
            "return": 0.5
          },
          {
            "title": "Sum vector internal metrics matching the name and tags",
            "source": "aggregate_vector_metrics(\"sum\", \"utilization\", tags: {\"component_id\": \"test\"})",
            "return": 0.5
          },
          {
            "title": "Average of vector internal metrics matching the name",
            "source": "aggregate_vector_metrics(\"avg\", \"utilization\")",
            "return": 0.5
          },
          {
            "title": "Max of vector internal metrics matching the name",
            "source": "aggregate_vector_metrics(\"max\", \"utilization\")",
            "return": 0.5
          },
          {
