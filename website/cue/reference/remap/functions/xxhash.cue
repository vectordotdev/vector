  ...
  "remap": {
    "functions": {
      "xxhash": {
        ...
        "name": "xxhash",
        "category": "Checksum",
        "description": "Calculates a [xxHash](https://github.com/DoumanAsh/xxhash-rust) hash of the `value`.",
        "arguments": [
          {
            "name": "value",
