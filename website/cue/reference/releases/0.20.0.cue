	...
	changelog: [
		...
		},
		{
			...
			description: """
				...
				[highlight article for named output metrics](2022-01-19-component-sent-metrics-output-tag).
				"""
			pr_numbers: [10738]
		},
		{
		...
		},
		{
			...
			description: """
				...
				metrics](2022-01-19-component-sent-metrics-output-tag).
				"""
			pr_numbers: [10869]
		},
		{
		...
		},
		{
			...
			description: """
				The `vector` source and `vector` sink now default to version 2 of the protocl for inter-Vector
		...
		},
		{
			...
			description: """
				Several deprecated `elasticsearch` options have been removed as described in the [upgrade
				guide](highlights/2022-02-08-0-20-0-upgrade-guide#deprecate-v1). details.
				"""
			pr_numbers: [11028]
		},
		{
