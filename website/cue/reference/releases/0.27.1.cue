...
releases: "0.27.1": {
	...
	commits: [
		...
		{sha: "f73f0c800d6c5b1bc83e030ef11c26e1dcaa055f", date: "2023-02-14 16:01:20 UTC", description: "fix source metadata paths from being flattened with `insert_standard_vector_source_metadata`", pr_number: 16410, scopes: ["core"], type: "fix", breaking_change: false, author: "Nathan Fox", files_count: 1, insertions_count: 31, deletions_count: 2},
