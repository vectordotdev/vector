...
releases: "0.42.0": {
		...
		},
		{
			...
			description: """
				...
				- The `_time` field in data sent to Axiom now supports the same semantics as the
				  ...
				  surprising for seasoned Axiom users new to Vector and seasoned Vector users new
				  to Axiom alike.
	...
	commits: [
		...
		{sha: "e250dcbff7e5cd89ba5d880065414576c89d4327", date: "2024-10-10 06:54:55 UTC", description: "simplify changelog validation to always check for authors", pr_number: 21463, scopes: ["ci"], type: "chore", breaking_change: false, author: "Pavlos Rontidis", files_count: 2, insertions_count: 18, deletions_count: 44},
		...
		{sha: "441bf23e590fcc4f0043657beca25318f8c16cf5", date: "2024-10-16 00:26:01 UTC", description: "tweak nightly schedule", pr_number: 21506, scopes: ["ci"], type: "chore", breaking_change: false, author: "Pavlos Rontidis", files_count: 1, insertions_count: 1, deletions_count: 1},
