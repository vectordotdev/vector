			...
			type: object: {
				...
				options: {
					tags: {
						required: false
						description: """
							Controls which tags should be emitted with the `vector_component_sent_events_total` and
						...
						type: object: {
							...
							options: {
								emit_source: {
									common: true
									description: """
										Emit the name of the source component the event was received from. If there is
										no source component, for example if the event was generated by the `lua` transform
										a `-` is emitted for this tag.
										"""
									required: false
									type: bool: {
										default: false
								...
								emit_service: {
									common: false
									description: """
										Emit the service the event was generated by. This is taken from a field of the event
										that has been determined to mean `service`. The field used depends on the source
										of the data. For example, with `syslog` events the `appname` field is used. If no
										service is available a `-` is emitted for this tag.
										"""
									required: false
									type: bool: {
										default: false
