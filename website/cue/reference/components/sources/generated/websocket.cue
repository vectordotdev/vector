...
generated: components: sources: websocket: configuration: decoding: decodingBase & {
	type: object: options: codec: {
		required: false
		type: string: default: "bytes"
	}
}
generated: components: sources: websocket: configuration: framing: framingDecoderBase & {
