...
generated: components: sources: aws_kinesis_firehose: configuration: decoding: decodingBase & {
	type: object: options: codec: {
		required: false
		type: string: default: "bytes"
	}
}
generated: components: sources: aws_kinesis_firehose: configuration: framing: framingDecoderBase & {
