...
generated: components: sources: heroku_logs: configuration: decoding: decodingBase & {
	type: object: options: codec: {
		required: false
		type: string: default: "bytes"
	}
}
generated: components: sources: heroku_logs: configuration: framing: framingDecoderBase & {
