...
generated: components: sources: http_server: configuration: decoding: decodingBase & {
	type: object: options: codec: required: true
}
generated: components: sources: http_server: configuration: framing: framingDecoderBase & {
