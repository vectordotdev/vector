...
function HighlightTagListPage(props) {
  const {tags} = props;
  ...
  const enrichedTags = enrichTags(normalizedTags, 'highlights');
  const groupedTags = _.groupBy(enrichedTags, 'category');

  return (
    <Layout title="Tags" description="Vector highlight tags">
...
export default HighlightTagListPage;
