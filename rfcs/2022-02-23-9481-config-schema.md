    ...
    Self: Clone,
{
    ...
    fn metadata() -> TypedMetadata<Self>;

    /// The fields for this value, if any.
    fn fields(overrides: TypedMetadata<Self>) -> Option<HashMap<&'static str, Field>>;
}
```
...
impl<'de> Configurable<'de> for SinkConfig {
    ...
    fn fields(overrides: TypedMetadata<Self>) -> Option<Vec<Field>> {
