...
urls: {
	...
	vrl_fail_safety:                                          "\(vrl_intro)#fail-safety"
	...
	vrl_path_expressions:                                     "\(vrl_expressions)#path_expressions"
	vrl_performance:                                          "\(vector_website)/docs/reference/vrl/#performance"
	vrl_reference:                                            "\(vector_website)/docs/reference/vrl/"
	vrl_safety:                                               "\(vector_website)/docs/reference/vrl/#safety"
	vrl_type_safety:                                          "\(vrl_intro)#type-safety"
