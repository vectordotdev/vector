remap: features: native: {
	...
	description: """
		...
		VRL and Vector are written in Rust, they are tightly integrated, avoiding communication inneficiencies such as
		event serialization or [foreign function interfaces](\(urls.ffi)). This makes VRL significantly faster than
