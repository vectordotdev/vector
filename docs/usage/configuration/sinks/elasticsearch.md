---
description: Batches and flushes log events to [Elasticsearch][elasticsearch] via the `_bulk` API endpoint
---
...
Due to nature of writing data to [Elasticsearch][elasticsearch] via the [`_bulk` API endpoint](https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-bulk.html), the `elasticsearch` sink
