---
description: Batches and flushes log events to [AWS Kinesis Data Stream][aws_kinesis_data_streams] via the `PutRecords` API endpoint
---
...
```coffeescript
[sources.my_aws_kinesis_streams_sink]
  # REQUIRED - General
...
The `aws_kinesis_streams` sinks offers an at least once delivery guarantee if your
