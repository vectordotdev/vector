...
* [Migrating](setup/migrating/README.md)
  * [Migrate From Fluent\*](setup/migrating/fluent.md)
  * [Migrate From Logstash](setup/migrating/logstash.md)
  * [Migrate From Splunk](setup/migrating/splunk.md)
...
* [Configuration](usage/configuration/README.md)
  ...
  * [Transforms](usage/configuration/transforms/README.md)
    ...
    * [format\_parser transform](usage/configuration/transforms/format_parser.md)
  ...
  * [Sinks](usage/configuration/sinks/README.md)
    ...
    * [\*.buffer](usage/configuration/sinks/buffer.md)
  * [Examples](usage/configuration/examples/README.md)
    * [File to Elasticsearch & S3](usage/configuration/examples/file-to-elasticsearch-and-s3.md)
    * [File to TCP](usage/configuration/examples/file-to-tcp.md)
