...
pub struct IggySourceConfig {
    ...
    #[derivative(Default(value = "default_commit_interval_secs()"))]
    ...
    #[derivative(Default(value = "default_drain_timeout_secs()"))]
    ...
    #[derivative(Default(value = "default_stream_key_field()"))]
