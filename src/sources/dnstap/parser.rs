...
impl<'a> DnstapParser<'a> {
        ...
        V: Into<Value>,
    {
        ...
        node_path.push(PathComponent::Key(String::from(key)));
    ...
    fn log_timestamp(
        ...
        self.insert(time_precision_key, time_precision);
    }
