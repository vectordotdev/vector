...
impl Picker {
    pub(crate) const fn new() -> Self {
        Self {
            state: PickerState::Uninitialized,
        }
    }
}
...
mod tests {
    ...
    fn test_parsing() {
        trace_init();
        test_util::test_parser(|| Transform::function(Picker::new()), Event::from, cases());
    }
