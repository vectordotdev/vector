        ...
        let dd_metric_request = DatadogSeriesRequest {
            series: vec![
                DatadogSeriesMetric {
                    ...
                    tags: Some(vec!["foo:bar".into()]),
                    host: Some("random_host".into()),
                ...
                DatadogSeriesMetric {
                    ...
                    tags: Some(vec!["foo:bar:baz".into()]),
                    host: Some("another_random_host".into()),
                    source_type_name: None,
                    device: None,
                    metadata: None,
                },
                DatadogSeriesMetric {
                    ...
                    tags: Some(vec!["foobar".into()]),
                    host: Some("a_host".into()),
                    source_type_name: None,
                    device: None,
                    metadata: None,
                },
                DatadogSeriesMetric {
                    metric: "system.disk.free".into(),
                    r#type: DatadogMetricType::Count,
                    interval: None,
                    points: vec![DatadogPoint(1542182955, 16777216_f64)],
                    tags: None,
