...
pub struct InternalMetricsConfig {
    ...
    #[configurable(metadata(
        docs::additional_props_description = "Value of the additional metrics tag."
    ))]
...
#[configurable(metadata(docs::enum_tag_description = "Method for creating metric tag value."))]
