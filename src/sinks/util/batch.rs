...
where
    S: Clone,
{
    /// The maximum size of a batch that will be processed by a sink. This is based on the
    /// uncompressed size of the batched events, before they are serialized / compressed.
