//! Implementation of the `sumo_logic` sink.

use super::request_builder::SumoLogicRequestBuilder;
use crate::sinks::{
    prelude::*,
    util::http::{HttpJsonBatchSizer, HttpRequest},
};
pub(super) struct SumoLogicSink<S> {
    service: S,
    batch_settings: BatcherSettings,
    request_builder: SumoLogicRequestBuilder,
}
