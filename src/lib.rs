...
use self::internal_telemetry::allocations::GroupedTracingAllocator;
...
#[global_allocator]
static ALLOC: GroupedTracingAllocator<tikv_jemallocator::Jemalloc> =
    GroupedTracingAllocator::new(tikv_jemallocator::Jemalloc);
