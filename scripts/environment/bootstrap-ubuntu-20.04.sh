...
TEMP=$(mktemp -d)
curl \
    -L https://github.com/cuelang/cue/releases/download/v0.3.0-beta.4/cue_0.3.0-beta.4_Linux_x86_64.tar.gz \
    -o "${TEMP}/cue_0.3.0-beta.4_Linux_x86_64.tar.gz"
tar \
    -xvf "${TEMP}/cue_0.3.0-beta.4_Linux_x86_64.tar.gz" \
    -C "${TEMP}"
