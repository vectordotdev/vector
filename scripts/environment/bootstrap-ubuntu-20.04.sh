...
TEMP=$(mktemp -d)
curl \
    -L https://github.com/cue-lang/cue/releases/download/v0.8.0/cue_v0.8.0_linux_amd64.tar.gz \
    -o "${TEMP}/cue_v0.8.0_linux_amd64.tar.gz"
tar \
    -xvf "${TEMP}/cue_v0.8.0_linux_amd64.tar.gz" \
    -C "${TEMP}"
