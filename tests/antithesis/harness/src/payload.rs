// This intentionally mirrors disk_v2's default write-buffer size without pulling
...
const PAYLOAD_LENGTHS: [usize; 8] = [
    0,
    1,
    DISK_V2_WRITE_BUFFER_SIZE / 4,
    DISK_V2_WRITE_BUFFER_SIZE / 2,
    DISK_V2_WRITE_BUFFER_SIZE - 1,
    DISK_V2_WRITE_BUFFER_SIZE,
    DISK_V2_WRITE_BUFFER_SIZE + 1,
    768 * 1024,
];
